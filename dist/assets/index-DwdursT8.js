...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Qn,depthTest:!1,depthWrite:!1})}function Qc(){return new Dt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Hl(),fragmentShader:`
		...
		`,blending:Qn,depthTest:!1,depthWrite:!1})}function eh(){return new Dt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Hl(),fragmentShader:`
...
`].filter(qs).join(`
`)),o=hl(o),o=uh(o,t),o=dh(o,t),a=hl(a),a=uh(a,t),a=dh(a,t),o=fh(o),a=fh(a),t.isRawShaderMaterial!==!0&&(M=`#version 300 es
...
`)+`
`+p);const S=M+m+o,y=M+p+a,R=lh(i,i.VERTEX_SHADER,S),T=lh(i,i.FRAGMENT_SHADER,y);i.attachShader(v,R),i.attachShader(v,T),t.index0AttributeName!==void 0?i.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(v,0,"position"),i.linkProgram(v);function A(L){if(s.debug.checkShaderErrors){const F=i.getProgramInfoLog(v)||"",z=i.getShaderInfoLog(R)||"",X=i.getShaderInfoLog(T)||"",q=F.trim(),j=z.trim(),ne=X.trim();let Y=!0,pe=!0;if(i.getProgramParameter(v,i.LINK_STATUS)===!1)if(Y=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,v,R,T);else{const xe=hh(i,R,"vertex"),Le=hh(i,T,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(v,i.VALIDATE_STATUS)+`
...
}`;function Hv(s,e,t){let n=new Cl;const i=new oe,r=new oe,o=new it,a=new kf({depthPacking:dd}),l=new Bf,c={},h=t.maxTextureSize,u={[ii]:Yt,[Yt]:ii,[Gt]:Gt},d=new Dt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new oe},radius:{value:4}},vertexShader:Bv,fragmentShader:zv}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const g=new Ct;g.setAttribute("position",new Mt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new De(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ih;let p=this.type;this.render=function(T,A,P){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||T.length===0)return;const _=s.getRenderTarget(),x=s.getActiveCubeFace(),L=s.getActiveMipmapLevel(),F=s.state;F.setBlending(Qn),F.buffers.depth.getReversed()===!0?F.buffers.color.setClear(0,0,0,0):F.buffers.color.setClear(1,1,1,1),F.buffers.depth.setTest(!0),F.setScissorTest(!1);const z=p!==$n&&this.type===$n,X=p===$n&&this.type!==$n;for(let q=0,j=T.length;q<j;q++){const ne=T[q],Y=ne.shadow;if(Y===void 0){console.warn("THREE.WebGLShadowMap:",ne,"has no shadow.");continue}if(Y.autoUpdate===!1&&Y.needsUpdate===!1)continue;i.copy(Y.mapSize);const pe=Y.getFrameExtents();if(i.multiply(pe),r.copy(Y.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(r.x=Math.floor(h/pe.x),i.x=r.x*pe.x,Y.mapSize.x=r.x),i.y>h&&(r.y=Math.floor(h/pe.y),i.y=r.y*pe.y,Y.mapSize.y=r.y)),Y.map===null||z===!0||X===!0){const Le=this.type!==$n?{minFilter:sn,magFilter:sn}:{};Y.map!==null&&Y.map.dispose(),Y.map=new bn(i.x,i.y,Le),Y.map.texture.name=ne.name+".shadowMap",Y.camera.updateProjectionMatrix()}s.setRenderTarget(Y.map),s.clear();const xe=Y.getViewportCount();for(let Le=0;Le<xe;Le++){const qe=Y.getViewport(Le);o.set(r.x*qe.x,r.y*qe.y,r.x*qe.z,r.y*qe.w),F.viewport(o),Y.updateMatrices(ne,Le),n=Y.getFrustum(),y(A,P,Y.camera,ne,this.type)}Y.isPointLightShadow!==!0&&this.type===$n&&M(Y,P),Y.needsUpdate=!1}p=this.type,m.needsUpdate=!1,s.setRenderTarget(_,x,L)};function M(T,A){const P=e.update(v);d.defines.VSM_SAMPLES!==T.blurSamples&&(d.defines.VSM_SAMPLES=T.blurSamples,f.defines.VSM_SAMPLES=T.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new bn(i.x,i.y)),d.uniforms.shadow_pass.value=T.map.texture,d.uniforms.resolution.value=T.mapSize,d.uniforms.radius.value=T.radius,s.setRenderTarget(T.mapPass),s.clear(),s.renderBufferDirect(A,null,P,d,v,null),f.uniforms.shadow_pass.value=T.mapPass.texture,f.uniforms.resolution.value=T.mapSize,f.uniforms.radius.value=T.radius,s.setRenderTarget(T.map),s.clear(),s.renderBufferDirect(A,null,P,f,v,null)}function S(T,A,P,_){let x=null;const L=P.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(L!==void 0)x=L;else if(x=P.isPointLight===!0?l:a,s.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0||A.alphaToCoverage===!0){const F=x.uuid,z=A.uuid;let X=c[F];X===void 0&&(X={},c[F]=X);let q=X[z];q===void 0&&(q=x.clone(),X[z]=q,A.addEventListener("dispose",R)),x=q}if(x.visible=A.visible,x.wireframe=A.wireframe,_===$n?x.side=A.shadowSide!==null?A.shadowSide:A.side:x.side=A.shadowSide!==null?A.shadowSide:u[A.side],x.alphaMap=A.alphaMap,x.alphaTest=A.alphaToCoverage===!0?.5:A.alphaTest,x.map=A.map,x.clipShadows=A.clipShadows,x.clippingPlanes=A.clippingPlanes,x.clipIntersection=A.clipIntersection,x.displacementMap=A.displacementMap,x.displacementScale=A.displacementScale,x.displacementBias=A.displacementBias,x.wireframeLinewidth=A.wireframeLinewidth,x.linewidth=A.linewidth,P.isPointLight===!0&&x.isMeshDistanceMaterial===!0){const F=s.properties.get(x);F.light=P}return x}function y(T,A,P,_,x){if(T.visible===!1)return;if(T.layers.test(A.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&x===$n)&&(!T.frustumCulled||n.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(P.matrixWorldInverse,T.matrixWorld);const z=e.update(T),X=T.material;if(Array.isArray(X)){const q=z.groups;for(let j=0,ne=q.length;j<ne;j++){const Y=q[j],pe=X[Y.materialIndex];if(pe&&pe.visible){const xe=S(T,pe,_,x);T.onBeforeShadow(s,T,A,P,z,xe,Y),s.renderBufferDirect(P,null,z,xe,T,Y),T.onAfterShadow(s,T,A,P,z,xe,Y)}}}else if(X.visible){const q=S(T,X,_,x);T.onBeforeShadow(s,T,A,P,z,q,null),s.renderBufferDirect(P,null,z,q,T,null),T.onAfterShadow(s,T,A,P,z,q,null)}}const F=T.children;for(let z=0,X=F.length;z<X;z++)y(F[z],A,P,_,x)}function R(T){T.target.removeEventListener("dispose",R);for(const P in c){const _=c[P],x=T.target.uuid;x in _&&(_[x].dispose(),delete _[x])}}}const Vv={[Ma]:Sa,[Ta]:Aa,[wa]:Ra,[ds]:Ea,[Sa]:Ma,[Aa]:Ta,[Ra]:wa,[Ea]:ds};function Gv(s,e){function t(){let N=!1;const re=new it;let ue=null;const Te=new it(0,0,0,0);return{setMask:function(ae){ue!==ae&&!N&&(s.colorMask(ae,ae,ae,ae),ue=ae)},setLocked:function(ae){N=ae},setClear:function(ae,ee,Re,Ve,bt){bt===!0&&(ae*=Ve,ee*=Ve,Re*=Ve),re.set(ae,ee,Re,Ve),Te.equals(re)===!1&&(s.clearColor(ae,ee,Re,Ve),Te.copy(re))},reset:function(){N=!1,ue=null,Te.set(-1,0,0,0)}}}function n(){let N=!1,re=!1,ue=null,Te=null,ae=null;return{setReversed:function(ee){if(re!==ee){const Re=e.get("EXT_clip_control");ee?Re.clipControlEXT(Re.LOWER_LEFT_EXT,Re.ZERO_TO_ONE_EXT):Re.clipControlEXT(Re.LOWER_LEFT_EXT,Re.NEGATIVE_ONE_TO_ONE_EXT),re=ee;const Ve=ae;ae=null,this.setClear(Ve)}},getReversed:function(){return re},setTest:function(ee){ee?K(s.DEPTH_TEST):Me(s.DEPTH_TEST)},setMask:function(ee){ue!==ee&&!N&&(s.depthMask(ee),ue=ee)},setFunc:function(ee){if(re&&(ee=Vv[ee]),Te!==ee){switch(ee){case Ma:s.depthFunc(s.NEVER);break;case Sa:s.depthFunc(s.ALWAYS);break;case Ta:s.depthFunc(s.LESS);break;case ds:s.depthFunc(s.LEQUAL);break;case wa:s.depthFunc(s.EQUAL);break;case Ea:s.depthFunc(s.GEQUAL);break;case Aa:s.depthFunc(s.GREATER);break;case Ra:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}Te=ee}},setLocked:function(ee){N=ee},setClear:function(ee){ae!==ee&&(re&&(ee=1-ee),s.clearDepth(ee),ae=ee)},reset:function(){N=!1,ue=null,Te=null,ae=null,re=!1}}}function i(){let N=!1,re=null,ue=null,Te=null,ae=null,ee=null,Re=null,Ve=null,bt=null;return{setTest:function(rt){N||(rt?K(s.STENCIL_TEST):Me(s.STENCIL_TEST))},setMask:function(rt){re!==rt&&!N&&(s.stencilMask(rt),re=rt)},setFunc:function(rt,Gn,Nn){(ue!==rt||Te!==Gn||ae!==Nn)&&(s.stencilFunc(rt,Gn,Nn),ue=rt,Te=Gn,ae=Nn)},setOp:function(rt,Gn,Nn){(ee!==rt||Re!==Gn||Ve!==Nn)&&(s.stencilOp(rt,Gn,Nn),ee=rt,Re=Gn,Ve=Nn)},setLocked:function(rt){N=rt},setClear:function(rt){bt!==rt&&(s.clearStencil(rt),bt=rt)},reset:function(){N=!1,re=null,ue=null,Te=null,ae=null,ee=null,Re=null,Ve=null,bt=null}}}const r=new t,o=new n,a=new i,l=new WeakMap,c=new WeakMap;let h={},u={},d=new WeakMap,f=[],g=null,v=!1,m=null,p=null,M=null,S=null,y=null,R=null,T=null,A=new _e(0,0,0),P=0,_=!1,x=null,L=null,F=null,z=null,X=null;const q=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let j=!1,ne=0;const Y=s.getParameter(s.VERSION);Y.indexOf("WebGL")!==-1?(ne=parseFloat(/^WebGL (\d)/.exec(Y)[1]),j=ne>=1):Y.indexOf("OpenGL ES")!==-1&&(ne=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),j=ne>=2);let pe=null,xe={};const Le=s.getParameter(s.SCISSOR_BOX),qe=s.getParameter(s.VIEWPORT),st=new it().fromArray(Le),yt=new it().fromArray(qe);function Qe(N,re,ue,Te){const ae=new Uint8Array(4),ee=s.createTexture();s.bindTexture(N,ee),s.texParameteri(N,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(N,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let Re=0;Re<ue;Re++)N===s.TEXTURE_3D||N===s.TEXTURE_2D_ARRAY?s.texImage3D(re,0,s.RGBA,1,1,Te,0,s.RGBA,s.UNSIGNED_BYTE,ae):s.texImage2D(re+Re,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,ae);return ee}const Z={};Z[s.TEXTURE_2D]=Qe(s.TEXTURE_2D,s.TEXTURE_2D,1),Z[s.TEXTURE_CUBE_MAP]=Qe(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),Z[s.TEXTURE_2D_ARRAY]=Qe(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),Z[s.TEXTURE_3D]=Qe(s.TEXTURE_3D,s.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),K(s.DEPTH_TEST),o.setFunc(ds),Oe(!1),we(Zl),K(s.CULL_FACE),gt(Qn);function K(N){h[N]!==!0&&(s.enable(N),h[N]=!0)}function Me(N){h[N]!==!1&&(s.disable(N),h[N]=!1)}function Fe(N,re){return u[N]!==re?(s.bindFramebuffer(N,re),u[N]=re,N===s.DRAW_FRAMEBUFFER&&(u[s.FRAMEBUFFER]=re),N===s.FRAMEBUFFER&&(u[s.DRAW_FRAMEBUFFER]=re),!0):!1}function Ce(N,re){let ue=f,Te=!1;if(N){ue=d.get(re),ue===void 0&&(ue=[],d.set(re,ue));const ae=N.textures;if(ue.length!==ae.length||ue[0]!==s.COLOR_ATTACHMENT0){for(let ee=0,Re=ae.length;ee<Re;ee++)ue[ee]=s.COLOR_ATTACHMENT0+ee;ue.length=ae.length,Te=!0}}else ue[0]!==s.BACK&&(ue[0]=s.BACK,Te=!0);Te&&s.drawBuffers(ue)}function je(N){return g!==N?(s.useProgram(N),g=N,!0):!1}const Ut={[Ii]:s.FUNC_ADD,[Gu]:s.FUNC_SUBTRACT,[Wu]:s.FUNC_REVERSE_SUBTRACT};Ut[Xu]=s.MIN,Ut[qu]=s.MAX;const D={[Yu]:s.ZERO,[ju]:s.ONE,[Ku]:s.SRC_COLOR,[ya]:s.SRC_ALPHA,[td]:s.SRC_ALPHA_SATURATE,[Qu]:s.DST_COLOR,[Zu]:s.DST_ALPHA,[$u]:s.ONE_MINUS_SRC_COLOR,[ba]:s.ONE_MINUS_SRC_ALPHA,[ed]:s.ONE_MINUS_DST_COLOR,[Ju]:s.ONE_MINUS_DST_ALPHA,[nd]:s.CONSTANT_COLOR,[id]:s.ONE_MINUS_CONSTANT_COLOR,[sd]:s.CONSTANT_ALPHA,[rd]:s.ONE_MINUS_CONSTANT_ALPHA};function gt(N,re,ue,Te,ae,ee,Re,Ve,bt,rt){if(N===Qn){v===!0&&(Me(s.BLEND),v=!1);return}if(v===!1&&(K(s.BLEND),v=!0),N!==Vu){if(N!==m||rt!==_){if((p!==Ii||y!==Ii)&&(s.blendEquation(s.FUNC_ADD),p=Ii,y=Ii),rt)switch(N){case Ni:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case si:s.blendFunc(s.ONE,s.ONE);break;case Jl:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Ql:s.blendFuncSeparate(s.DST_COLOR,s.ONE_MINUS_SRC_ALPHA,s.ZERO,s.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}else switch(N){case Ni:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case si:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE,s.ONE,s.ONE);break;case Jl:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Ql:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}M=null,S=null,R=null,T=null,A.set(0,0,0),P=0,m=N,_=rt}return}ae=ae||re,ee=ee||ue,Re=Re||Te,(re!==p||ae!==y)&&(s.blendEquationSeparate(Ut[re],Ut[ae]),p=re,y=ae),(ue!==M||Te!==S||ee!==R||Re!==T)&&(s.blendFuncSeparate(D[ue],D[Te],D[ee],D[Re]),M=ue,S=Te,R=ee,T=Re),(Ve.equals(A)===!1||bt!==P)&&(s.blendColor(Ve.r,Ve.g,Ve.b,bt),A.copy(Ve),P=bt),m=N,_=!1}function He(N,re){N.side===Gt?Me(s.CULL_FACE):K(s.CULL_FACE);let ue=N.side===Yt;re&&(ue=!ue),Oe(ue),N.blending===Ni&&N.transparent===!1?gt(Qn):gt(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),o.setFunc(N.depthFunc),o.setTest(N.depthTest),o.setMask(N.depthWrite),r.setMask(N.colorWrite);const Te=N.stencilWrite;a.setTest(Te),Te&&(a.setMask(N.stencilWriteMask),a.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),a.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),Ee(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?K(s.SAMPLE_ALPHA_TO_COVERAGE):Me(s.SAMPLE_ALPHA_TO_COVERAGE)}function Oe(N){x!==N&&(N?s.frontFace(s.CW):s.frontFace(s.CCW),x=N)}function we(N){N!==zu?(K(s.CULL_FACE),N!==L&&(N===Zl?s.cullFace(s.BACK):N===Hu?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):Me(s.CULL_FACE),L=N}function vt(N){N!==F&&(j&&s.lineWidth(N),F=N)}function Ee(N,re,ue){N?(K(s.POLYGON_OFFSET_FILL),(z!==re||X!==ue)&&(s.polygonOffset(re,ue),z=re,X=ue)):Me(s.POLYGON_OFFSET_FILL)}function We(N){N?K(s.SCISSOR_TEST):Me(s.SCISSOR_TEST)}function Nt(N){N===void 0&&(N=s.TEXTURE0+q-1),pe!==N&&(s.activeTexture(N),pe=N)}function Et(N,re,ue){ue===void 0&&(pe===null?ue=s.TEXTURE0+q-1:ue=pe);let Te=xe[ue];Te===void 0&&(Te={type:void 0,texture:void 0},xe[ue]=Te),(Te.type!==N||Te.texture!==re)&&(pe!==ue&&(s.activeTexture(ue),pe=ue),s.bindTexture(N,re||Z[N]),Te.type=N,Te.texture=re)}function C(){const N=xe[pe];N!==void 0&&N.type!==void 0&&(s.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function b(){try{s.compressedTexImage2D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function B(){try{s.compressedTexImage3D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function $(){try{s.texSubImage2D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function I(){try{s.texSubImage3D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function U(){try{s.compressedTexSubImage2D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function W(){try{s.compressedTexSubImage3D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function H(){try{s.texStorage2D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function se(){try{s.texStorage3D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function de(){try{s.texImage2D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function ie(){try{s.texImage3D(...arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function he(N){st.equals(N)===!1&&(s.scissor(N.x,N.y,N.z,N.w),st.copy(N))}function Pe(N){yt.equals(N)===!1&&(s.viewport(N.x,N.y,N.z,N.w),yt.copy(N))}function ye(N,re){let ue=c.get(re);ue===void 0&&(ue=new WeakMap,c.set(re,ue));let Te=ue.get(N);Te===void 0&&(Te=s.getUniformBlockIndex(re,N.name),ue.set(N,Te))}function fe(N,re){const Te=c.get(re).get(N);l.get(re)!==Te&&(s.uniformBlockBinding(re,Te,N.__bindingPointIndex),l.set(re,Te))}function Ne(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),o.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),h={},pe=null,xe={},u={},d=new WeakMap,f=[],g=null,v=!1,m=null,p=null,M=null,S=null,y=null,R=null,T=null,A=new _e(0,0,0),P=0,_=!1,x=null,L=null,F=null,z=null,X=null,st.set(0,0,s.canvas.width,s.canvas.height),yt.set(0,0,s.canvas.width,s.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:K,disable:Me,bindFramebuffer:Fe,drawBuffers:Ce,useProgram:je,setBlending:gt,setMaterial:He,setFlipSided:Oe,setCullFace:we,setLineWidth:vt,setPolygonOffset:Ee,setScissorTest:We,activeTexture:Nt,bindTexture:Et,unbindTexture:C,compressedTexImage2D:b,compressedTexImage3D:B,texImage2D:de,texImage3D:ie,updateUBOMapping:ye,uniformBlockBinding:fe,texStorage2D:H,texStorage3D:se,texSubImage2D:$,texSubImage3D:I,compressedTexSubImage2D:U,compressedTexSubImage3D:W,scissor:he,viewport:Pe,reset:Ne}}function Wv(s,e,t,n,i,r,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new oe,h=new WeakMap;let u;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(C,b){return f?new OffscreenCanvas(C,b):or("canvas")}function v(C,b,B){let $=1;const I=Et(C);if((I.width>B||I.height>B)&&($=B/Math.max(I.width,I.height)),$<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){const U=Math.floor($*I.width),W=Math.floor($*I.height);u===void 0&&(u=g(U,W));const H=b?g(U,W):u;return H.width=U,H.height=W,H.getContext("2d").drawImage(C,0,0,U,W),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+I.width+"x"+I.height+") to ("+U+"x"+W+")."),H}else return"data"in C&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+I.width+"x"+I.height+")."),C;return C}function m(C){return C.generateMipmaps}function p(C){s.generateMipmap(C)}function M(C){return C.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:C.isWebGL3DRenderTarget?s.TEXTURE_3D:C.isWebGLArrayRenderTarget||C.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function S(C,b,B,$,I=!1){if(C!==null){if(s[C]!==void 0)return s[C];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let U=b;if(b===s.RED&&(B===s.FLOAT&&(U=s.R32F),B===s.HALF_FLOAT&&(U=s.R16F),B===s.UNSIGNED_BYTE&&(U=s.R8)),b===s.RED_INTEGER&&(B===s.UNSIGNED_BYTE&&(U=s.R8UI),B===s.UNSIGNED_SHORT&&(U=s.R16UI),B===s.UNSIGNED_INT&&(U=s.R32UI),B===s.BYTE&&(U=s.R8I),B===s.SHORT&&(U=s.R16I),B===s.INT&&(U=s.R32I)),b===s.RG&&(B===s.FLOAT&&(U=s.RG32F),B===s.HALF_FLOAT&&(U=s.RG16F),B===s.UNSIGNED_BYTE&&(U=s.RG8)),b===s.RG_INTEGER&&(B===s.UNSIGNED_BYTE&&(U=s.RG8UI),B===s.UNSIGNED_SHORT&&(U=s.RG16UI),B===s.UNSIGNED_INT&&(U=s.RG32UI),B===s.BYTE&&(U=s.RG8I),B===s.SHORT&&(U=s.RG16I),B===s.INT&&(U=s.RG32I)),b===s.RGB_INTEGER&&(B===s.UNSIGNED_BYTE&&(U=s.RGB8UI),B===s.UNSIGNED_SHORT&&(U=s.RGB16UI),B===s.UNSIGNED_INT&&(U=s.RGB32UI),B===s.BYTE&&(U=s.RGB8I),B===s.SHORT&&(U=s.RGB16I),B===s.INT&&(U=s.RGB32I)),b===s.RGBA_INTEGER&&(B===s.UNSIGNED_BYTE&&(U=s.RGBA8UI),B===s.UNSIGNED_SHORT&&(U=s.RGBA16UI),B===s.UNSIGNED_INT&&(U=s.RGBA32UI),B===s.BYTE&&(U=s.RGBA8I),B===s.SHORT&&(U=s.RGBA16I),B===s.INT&&(U=s.RGBA32I)),b===s.RGB&&(B===s.UNSIGNED_INT_5_9_9_9_REV&&(U=s.RGB9_E5),B===s.UNSIGNED_INT_10F_11F_11F_REV&&(U=s.R11F_G11F_B10F)),b===s.RGBA){const W=I?lo:Je.getTransfer($);B===s.FLOAT&&(U=s.RGBA32F),B===s.HALF_FLOAT&&(U=s.RGBA16F),B===s.UNSIGNED_BYTE&&(U=W===at?s.SRGB8_ALPHA8:s.RGBA8),B===s.UNSIGNED_SHORT_4_4_4_4&&(U=s.RGBA4),B===s.UNSIGNED_SHORT_5_5_5_1&&(U=s.RGB5_A1)}return(U===s.R16F||U===s.R32F||U===s.RG16F||U===s.RG32F||U===s.RGBA16F||U===s.RGBA32F)&&e.get("EXT_color_buffer_float"),U}function y(C,b){let B;return C?b===null||b===Oi||b===tr?B=s.DEPTH24_STENCIL8:b===Rn?B=s.DEPTH32F_STENCIL8:b===er&&(B=s.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):b===null||b===Oi||b===tr?B=s.DEPTH_COMPONENT24:b===Rn?B=s.DEPTH_COMPONENT32F:b===er&&(B=s.DEPTH_COMPONENT16),B}function R(C,b){return m(C)===!0||C.isFramebufferTexture&&C.minFilter!==sn&&C.minFilter!==nn?Math.log2(Math.max(b.width,b.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?b.mipmaps.length:1}function T(C){const b=C.target;b.removeEventListener("dispose",T),P(b),b.isVideoTexture&&h.delete(b)}function A(C){const b=C.target;b.removeEventListener("dispose",A),x(b)}function P(C){const b=n.get(C);if(b.__webglInit===void 0)return;const B=C.source,$=d.get(B);if($){const I=$[b.__cacheKey];I.usedTimes--,I.usedTimes===0&&_(C),Object.keys($).length===0&&d.delete(B)}n.remove(C)}function _(C){const b=n.get(C);s.deleteTexture(b.__webglTexture);const B=C.source,$=d.get(B);delete $[b.__cacheKey],o.memory.textures--}function x(C){const b=n.get(C);if(C.depthTexture&&(C.depthTexture.dispose(),n.remove(C.depthTexture)),C.isWebGLCubeRenderTarget)for(let $=0;$<6;$++){if(Array.isArray(b.__webglFramebuffer[$]))for(let I=0;I<b.__webglFramebuffer[$].length;I++)s.deleteFramebuffer(b.__webglFramebuffer[$][I]);else s.deleteFramebuffer(b.__webglFramebuffer[$]);b.__webglDepthbuffer&&s.deleteRenderbuffer(b.__webglDepthbuffer[$])}else{if(Array.isArray(b.__webglFramebuffer))for(let $=0;$<b.__webglFramebuffer.length;$++)s.deleteFramebuffer(b.__webglFramebuffer[$]);else s.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&s.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&s.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let $=0;$<b.__webglColorRenderbuffer.length;$++)b.__webglColorRenderbuffer[$]&&s.deleteRenderbuffer(b.__webglColorRenderbuffer[$]);b.__webglDepthRenderbuffer&&s.deleteRenderbuffer(b.__webglDepthRenderbuffer)}const B=C.textures;for(let $=0,I=B.length;$<I;$++){const U=n.get(B[$]);U.__webglTexture&&(s.deleteTexture(U.__webglTexture),o.memory.textures--),n.remove(B[$])}n.remove(C)}let L=0;function F(){L=0}function z(){const C=L;return C>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+i.maxTextures),L+=1,C}function X(C){const b=[];return b.push(C.wrapS),b.push(C.wrapT),b.push(C.wrapR||0),b.push(C.magFilter),b.push(C.minFilter),b.push(C.anisotropy),b.push(C.internalFormat),b.push(C.format),b.push(C.type),b.push(C.generateMipmaps),b.push(C.premultiplyAlpha),b.push(C.flipY),b.push(C.unpackAlignment),b.push(C.colorSpace),b.join()}function q(C,b){const B=n.get(C);if(C.isVideoTexture&&We(C),C.isRenderTargetTexture===!1&&C.isExternalTexture!==!0&&C.version>0&&B.__version!==C.version){const $=C.image;if($===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if($.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Z(B,C,b);return}}else C.isExternalTexture&&(B.__webglTexture=C.sourceTexture?C.sourceTexture:null);t.bindTexture(s.TEXTURE_2D,B.__webglTexture,s.TEXTURE0+b)}function j(C,b){const B=n.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&B.__version!==C.version){Z(B,C,b);return}t.bindTexture(s.TEXTURE_2D_ARRAY,B.__webglTexture,s.TEXTURE0+b)}function ne(C,b){const B=n.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&B.__version!==C.version){Z(B,C,b);return}t.bindTexture(s.TEXTURE_3D,B.__webglTexture,s.TEXTURE0+b)}function Y(C,b){const B=n.get(C);if(C.version>0&&B.__version!==C.version){K(B,C,b);return}t.bindTexture(s.TEXTURE_CUBE_MAP,B.__webglTexture,s.TEXTURE0+b)}const pe={[on]:s.REPEAT,[gi]:s.CLAMP_TO_EDGE,[ao]:s.MIRRORED_REPEAT},xe={[sn]:s.NEAREST,[Gh]:s.NEAREST_MIPMAP_NEAREST,[Xs]:s.NEAREST_MIPMAP_LINEAR,[nn]:s.LINEAR,[Jr]:s.LINEAR_MIPMAP_NEAREST,[Zn]:s.LINEAR_MIPMAP_LINEAR},Le={[pd]:s.NEVER,[yd]:s.ALWAYS,[md]:s.LESS,[Qh]:s.LEQUAL,[gd]:s.EQUAL,[xd]:s.GEQUAL,[vd]:s.GREATER,[_d]:s.NOTEQUAL};function qe(C,b){if(b.type===Rn&&e.has("OES_texture_float_linear")===!1&&(b.magFilter===nn||b.magFilter===Jr||b.magFilter===Xs||b.magFilter===Zn||b.minFilter===nn||b.minFilter===Jr||b.minFilter===Xs||b.minFilter===Zn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(C,s.TEXTURE_WRAP_S,pe[b.wrapS]),s.texParameteri(C,s.TEXTURE_WRAP_T,pe[b.wrapT]),(C===s.TEXTURE_3D||C===s.TEXTURE_2D_ARRAY)&&s.texParameteri(C,s.TEXTURE_WRAP_R,pe[b.wrapR]),s.texParameteri(C,s.TEXTURE_MAG_FILTER,xe[b.magFilter]),s.texParameteri(C,s.TEXTURE_MIN_FILTER,xe[b.minFilter]),b.compareFunction&&(s.texParameteri(C,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(C,s.TEXTURE_COMPARE_FUNC,Le[b.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===sn||b.minFilter!==Xs&&b.minFilter!==Zn||b.type===Rn&&e.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||n.get(b).__currentAnisotropy){const B=e.get("EXT_texture_filter_anisotropic");s.texParameterf(C,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,i.getMaxAnisotropy())),n.get(b).__currentAnisotropy=b.anisotropy}}}function st(C,b){let B=!1;C.__webglInit===void 0&&(C.__webglInit=!0,b.addEventListener("dispose",T));const $=b.source;let I=d.get($);I===void 0&&(I={},d.set($,I));const U=X(b);if(U!==C.__cacheKey){I[U]===void 0&&(I[U]={texture:s.createTexture(),usedTimes:0},o.memory.textures++,B=!0),I[U].usedTimes++;const W=I[C.__cacheKey];W!==void 0&&(I[C.__cacheKey].usedTimes--,W.usedTimes===0&&_(b)),C.__cacheKey=U,C.__webglTexture=I[U].texture}return B}function yt(C,b,B){return Math.floor(Math.floor(C/B)/b)}function Qe(C,b,B,$){const U=C.updateRanges;if(U.length===0)t.texSubImage2D(s.TEXTURE_2D,0,0,0,b.width,b.height,B,$,b.data);else{U.sort((ie,he)=>ie.start-he.start);let W=0;for(let ie=1;ie<U.length;ie++){const he=U[W],Pe=U[ie],ye=he.start+he.count,fe=yt(Pe.start,b.width,4),Ne=yt(he.start,b.width,4);Pe.start<=ye+1&&fe===Ne&&yt(Pe.start+Pe.count-1,b.width,4)===fe?he.count=Math.max(he.count,Pe.start+Pe.count-he.start):(++W,U[W]=Pe)}U.length=W+1;const H=s.getParameter(s.UNPACK_ROW_LENGTH),se=s.getParameter(s.UNPACK_SKIP_PIXELS),de=s.getParameter(s.UNPACK_SKIP_ROWS);s.pixelStorei(s.UNPACK_ROW_LENGTH,b.width);for(let ie=0,he=U.length;ie<he;ie++){const Pe=U[ie],ye=Math.floor(Pe.start/4),fe=Math.ceil(Pe.count/4),Ne=ye%b.width,N=Math.floor(ye/b.width),re=fe,ue=1;s.pixelStorei(s.UNPACK_SKIP_PIXELS,Ne),s.pixelStorei(s.UNPACK_SKIP_ROWS,N),t.texSubImage2D(s.TEXTURE_2D,0,Ne,N,re,ue,B,$,b.data)}C.clearUpdateRanges(),s.pixelStorei(s.UNPACK_ROW_LENGTH,H),s.pixelStorei(s.UNPACK_SKIP_PIXELS,se),s.pixelStorei(s.UNPACK_SKIP_ROWS,de)}}function Z(C,b,B){let $=s.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&($=s.TEXTURE_2D_ARRAY),b.isData3DTexture&&($=s.TEXTURE_3D);const I=st(C,b),U=b.source;t.bindTexture($,C.__webglTexture,s.TEXTURE0+B);const W=n.get(U);if(U.version!==W.__version||I===!0){t.activeTexture(s.TEXTURE0+B);const H=Je.getPrimaries(Je.workingColorSpace),se=b.colorSpace===mi?null:Je.getPrimaries(b.colorSpace),de=b.colorSpace===mi||H===se?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,b.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,b.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,de);let ie=v(b.image,!1,i.maxTextureSize);ie=Nt(b,ie);const he=r.convert(b.format,b.colorSpace),Pe=r.convert(b.type);let ye=S(b.internalFormat,he,Pe,b.colorSpace,b.isVideoTexture);qe($,b);let fe;const Ne=b.mipmaps,N=b.isVideoTexture!==!0,re=W.__version===void 0||I===!0,ue=U.dataReady,Te=R(b,ie);if(b.isDepthTexture)ye=y(b.format===ir,b.type),re&&(N?t.texStorage2D(s.TEXTURE_2D,1,ye,ie.width,ie.height):t.texImage2D(s.TEXTURE_2D,0,ye,ie.width,ie.height,0,he,Pe,null));else if(b.isDataTexture)if(Ne.length>0){N&&re&&t.texStorage2D(s.TEXTURE_2D,Te,ye,Ne[0].width,Ne[0].height);for(let ae=0,ee=Ne.length;ae<ee;ae++)fe=Ne[ae],N?ue&&t.texSubImage2D(s.TEXTURE_2D,ae,0,0,fe.width,fe.height,he,Pe,fe.data):t.texImage2D(s.TEXTURE_2D,ae,ye,fe.width,fe.height,0,he,Pe,fe.data);b.generateMipmaps=!1}else N?(re&&t.texStorage2D(s.TEXTURE_2D,Te,ye,ie.width,ie.height),ue&&Qe(b,ie,he,Pe)):t.texImage2D(s.TEXTURE_2D,0,ye,ie.width,ie.height,0,he,Pe,ie.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){N&&re&&t.texStorage3D(s.TEXTURE_2D_ARRAY,Te,ye,Ne[0].width,Ne[0].height,ie.depth);for(let ae=0,ee=Ne.length;ae<ee;ae++)if(fe=Ne[ae],b.format!==yn)if(he!==null)if(N){if(ue)if(b.layerUpdates.size>0){const Re=Yc(fe.width,fe.height,b.format,b.type);for(const Ve of b.layerUpdates){const bt=fe.data.subarray(Ve*Re/fe.data.BYTES_PER_ELEMENT,(Ve+1)*Re/fe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,ae,0,0,Ve,fe.width,fe.height,1,he,bt)}b.clearLayerUpdates()}else t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,ae,0,0,0,fe.width,fe.height,ie.depth,he,fe.data)}else t.compressedTexImage3D(s.TEXTURE_2D_ARRAY,ae,ye,fe.width,fe.height,ie.depth,0,fe.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else N?ue&&t.texSubImage3D(s.TEXTURE_2D_ARRAY,ae,0,0,0,fe.width,fe.height,ie.depth,he,Pe,fe.data):t.texImage3D(s.TEXTURE_2D_ARRAY,ae,ye,fe.width,fe.height,ie.depth,0,he,Pe,fe.data)}else{N&&re&&t.texStorage2D(s.TEXTURE_2D,Te,ye,Ne[0].width,Ne[0].height);for(let ae=0,ee=Ne.length;ae<ee;ae++)fe=Ne[ae],b.format!==yn?he!==null?N?ue&&t.compressedTexSubImage2D(s.TEXTURE_2D,ae,0,0,fe.width,fe.height,he,fe.data):t.compressedTexImage2D(s.TEXTURE_2D,ae,ye,fe.width,fe.height,0,fe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):N?ue&&t.texSubImage2D(s.TEXTURE_2D,ae,0,0,fe.width,fe.height,he,Pe,fe.data):t.texImage2D(s.TEXTURE_2D,ae,ye,fe.width,fe.height,0,he,Pe,fe.data)}else if(b.isDataArrayTexture)if(N){if(re&&t.texStorage3D(s.TEXTURE_2D_ARRAY,Te,ye,ie.width,ie.height,ie.depth),ue)if(b.layerUpdates.size>0){const ae=Yc(ie.width,ie.height,b.format,b.type);for(const ee of b.layerUpdates){const Re=ie.data.subarray(ee*ae/ie.data.BYTES_PER_ELEMENT,(ee+1)*ae/ie.data.BYTES_PER_ELEMENT);t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,ee,ie.width,ie.height,1,he,Pe,Re)}b.clearLayerUpdates()}else t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,ie.width,ie.height,ie.depth,he,Pe,ie.data)}else t.texImage3D(s.TEXTURE_2D_ARRAY,0,ye,ie.width,ie.height,ie.depth,0,he,Pe,ie.data);else if(b.isData3DTexture)N?(re&&t.texStorage3D(s.TEXTURE_3D,Te,ye,ie.width,ie.height,ie.depth),ue&&t.texSubImage3D(s.TEXTURE_3D,0,0,0,0,ie.width,ie.height,ie.depth,he,Pe,ie.data)):t.texImage3D(s.TEXTURE_3D,0,ye,ie.width,ie.height,ie.depth,0,he,Pe,ie.data);else if(b.isFramebufferTexture){if(re)if(N)t.texStorage2D(s.TEXTURE_2D,Te,ye,ie.width,ie.height);else{let ae=ie.width,ee=ie.height;for(let Re=0;Re<Te;Re++)t.texImage2D(s.TEXTURE_2D,Re,ye,ae,ee,0,he,Pe,null),ae>>=1,ee>>=1}}else if(Ne.length>0){if(N&&re){const ae=Et(Ne[0]);t.texStorage2D(s.TEXTURE_2D,Te,ye,ae.width,ae.height)}for(let ae=0,ee=Ne.length;ae<ee;ae++)fe=Ne[ae],N?ue&&t.texSubImage2D(s.TEXTURE_2D,ae,0,0,he,Pe,fe):t.texImage2D(s.TEXTURE_2D,ae,ye,he,Pe,fe);b.generateMipmaps=!1}else if(N){if(re){const ae=Et(ie);t.texStorage2D(s.TEXTURE_2D,Te,ye,ae.width,ae.height)}ue&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,he,Pe,ie)}else t.texImage2D(s.TEXTURE_2D,0,ye,he,Pe,ie);m(b)&&p($),W.__version=U.version,b.onUpdate&&b.onUpdate(b)}C.__version=b.version}function K(C,b,B){if(b.image.length!==6)return;const $=st(C,b),I=b.source;t.bindTexture(s.TEXTURE_CUBE_MAP,C.__webglTexture,s.TEXTURE0+B);const U=n.get(I);if(I.version!==U.__version||$===!0){t.activeTexture(s.TEXTURE0+B);const W=Je.getPrimaries(Je.workingColorSpace),H=b.colorSpace===mi?null:Je.getPrimaries(b.colorSpace),se=b.colorSpace===mi||W===H?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,b.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,b.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,se);const de=b.isCompressedTexture||b.image[0].isCompressedTexture,ie=b.image[0]&&b.image[0].isDataTexture,he=[];for(let ee=0;ee<6;ee++)!de&&!ie?he[ee]=v(b.image[ee],!0,i.maxCubemapSize):he[ee]=ie?b.image[ee].image:b.image[ee],he[ee]=Nt(b,he[ee]);const Pe=he[0],ye=r.convert(b.format,b.colorSpace),fe=r.convert(b.type),Ne=S(b.internalFormat,ye,fe,b.colorSpace),N=b.isVideoTexture!==!0,re=U.__version===void 0||$===!0,ue=I.dataReady;let Te=R(b,Pe);qe(s.TEXTURE_CUBE_MAP,b);let ae;if(de){N&&re&&t.texStorage2D(s.TEXTURE_CUBE_MAP,Te,Ne,Pe.width,Pe.height);for(let ee=0;ee<6;ee++){ae=he[ee].mipmaps;for(let Re=0;Re<ae.length;Re++){const Ve=ae[Re];b.format!==yn?ye!==null?N?ue&&t.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Re,0,0,Ve.width,Ve.height,ye,Ve.data):t.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Re,Ne,Ve.width,Ve.height,0,Ve.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?ue&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Re,0,0,Ve.width,Ve.height,ye,fe,Ve.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Re,Ne,Ve.width,Ve.height,0,ye,fe,Ve.data)}}}else{if(ae=b.mipmaps,N&&re){ae.length>0&&Te++;const ee=Et(he[0]);t.texStorage2D(s.TEXTURE_CUBE_MAP,Te,Ne,ee.width,ee.height)}for(let ee=0;ee<6;ee++)if(ie){N?ue&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,he[ee].width,he[ee].height,ye,fe,he[ee].data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Ne,he[ee].width,he[ee].height,0,ye,fe,he[ee].data);for(let Re=0;Re<ae.length;Re++){const bt=ae[Re].image[ee].image;N?ue&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Re+1,0,0,bt.width,bt.height,ye,fe,bt.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Re+1,Ne,bt.width,bt.height,0,ye,fe,bt.data)}}else{N?ue&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,ye,fe,he[ee]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Ne,ye,fe,he[ee]);for(let Re=0;Re<ae.length;Re++){const Ve=ae[Re];N?ue&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Re+1,0,0,ye,fe,Ve.image[ee]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Re+1,Ne,ye,fe,Ve.image[ee])}}}m(b)&&p(s.TEXTURE_CUBE_MAP),U.__version=I.version,b.onUpdate&&b.onUpdate(b)}C.__version=b.version}function Me(C,b,B,$,I,U){const W=r.convert(B.format,B.colorSpace),H=r.convert(B.type),se=S(B.internalFormat,W,H,B.colorSpace),de=n.get(b),ie=n.get(B);if(ie.__renderTarget=b,!de.__hasExternalTextures){const he=Math.max(1,b.width>>U),Pe=Math.max(1,b.height>>U);I===s.TEXTURE_3D||I===s.TEXTURE_2D_ARRAY?t.texImage3D(I,U,se,he,Pe,b.depth,0,W,H,null):t.texImage2D(I,U,se,he,Pe,0,W,H,null)}t.bindFramebuffer(s.FRAMEBUFFER,C),Ee(b)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,$,I,ie.__webglTexture,0,vt(b)):(I===s.TEXTURE_2D||I>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&I<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,$,I,ie.__webglTexture,U),t.bindFramebuffer(s.FRAMEBUFFER,null)}function Fe(C,b,B){if(s.bindRenderbuffer(s.RENDERBUFFER,C),b.depthBuffer){const $=b.depthTexture,I=$&&$.isDepthTexture?$.type:null,U=y(b.stencilBuffer,I),W=b.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,H=vt(b);Ee(b)?a.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,H,U,b.width,b.height):B?s.renderbufferStorageMultisample(s.RENDERBUFFER,H,U,b.width,b.height):s.renderbufferStorage(s.RENDERBUFFER,U,b.width,b.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,W,s.RENDERBUFFER,C)}else{const $=b.textures;for(let I=0;I<$.length;I++){const U=$[I],W=r.convert(U.format,U.colorSpace),H=r.convert(U.type),se=S(U.internalFormat,W,H,U.colorSpace),de=vt(b);B&&Ee(b)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,de,se,b.width,b.height):Ee(b)?a.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,de,se,b.width,b.height):s.renderbufferStorage(s.RENDERBUFFER,se,b.width,b.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function Ce(C,b){if(b&&b.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(s.FRAMEBUFFER,C),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const $=n.get(b.depthTexture);$.__renderTarget=b,(!$.__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),q(b.depthTexture,0);const I=$.__webglTexture,U=vt(b);if(b.depthTexture.format===nr)Ee(b)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,I,0,U):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,I,0);else if(b.depthTexture.format===ir)Ee(b)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,I,0,U):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,I,0);else throw new Error("Unknown depthTexture format")}function je(C){const b=n.get(C),B=C.isWebGLCubeRenderTarget===!0;if(b.__boundDepthTexture!==C.depthTexture){const $=C.depthTexture;if(b.__depthDisposeCallback&&b.__depthDisposeCallback(),$){const I=()=>{delete b.__boundDepthTexture,delete b.__depthDisposeCallback,$.removeEventListener("dispose",I)};$.addEventListener("dispose",I),b.__depthDisposeCallback=I}b.__boundDepthTexture=$}if(C.depthTexture&&!b.__autoAllocateDepthBuffer){if(B)throw new Error("target.depthTexture not supported in Cube render targets");const $=C.texture.mipmaps;$&&$.length>0?Ce(b.__webglFramebuffer[0],C):Ce(b.__webglFramebuffer,C)}else if(B){b.__webglDepthbuffer=[];for(let $=0;$<6;$++)if(t.bindFramebuffer(s.FRAMEBUFFER,b.__webglFramebuffer[$]),b.__webglDepthbuffer[$]===void 0)b.__webglDepthbuffer[$]=s.createRenderbuffer(),Fe(b.__webglDepthbuffer[$],C,!1);else{const I=C.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,U=b.__webglDepthbuffer[$];s.bindRenderbuffer(s.RENDERBUFFER,U),s.framebufferRenderbuffer(s.FRAMEBUFFER,I,s.RENDERBUFFER,U)}}else{const $=C.texture.mipmaps;if($&&$.length>0?t.bindFramebuffer(s.FRAMEBUFFER,b.__webglFramebuffer[0]):t.bindFramebuffer(s.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer===void 0)b.__webglDepthbuffer=s.createRenderbuffer(),Fe(b.__webglDepthbuffer,C,!1);else{const I=C.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,U=b.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,U),s.framebufferRenderbuffer(s.FRAMEBUFFER,I,s.RENDERBUFFER,U)}}t.bindFramebuffer(s.FRAMEBUFFER,null)}function Ut(C,b,B){const $=n.get(C);b!==void 0&&Me($.__webglFramebuffer,C,C.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),B!==void 0&&je(C)}function D(C){const b=C.texture,B=n.get(C),$=n.get(b);C.addEventListener("dispose",A);const I=C.textures,U=C.isWebGLCubeRenderTarget===!0,W=I.length>1;if(W||($.__webglTexture===void 0&&($.__webglTexture=s.createTexture()),$.__version=b.version,o.memory.textures++),U){B.__webglFramebuffer=[];for(let H=0;H<6;H++)if(b.mipmaps&&b.mipmaps.length>0){B.__webglFramebuffer[H]=[];for(let se=0;se<b.mipmaps.length;se++)B.__webglFramebuffer[H][se]=s.createFramebuffer()}else B.__webglFramebuffer[H]=s.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){B.__webglFramebuffer=[];for(let H=0;H<b.mipmaps.length;H++)B.__webglFramebuffer[H]=s.createFramebuffer()}else B.__webglFramebuffer=s.createFramebuffer();if(W)for(let H=0,se=I.length;H<se;H++){const de=n.get(I[H]);de.__webglTexture===void 0&&(de.__webglTexture=s.createTexture(),o.memory.textures++)}if(C.samples>0&&Ee(C)===!1){B.__webglMultisampledFramebuffer=s.createFramebuffer(),B.__webglColorRenderbuffer=[],t.bindFramebuffer(s.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let H=0;H<I.length;H++){const se=I[H];B.__webglColorRenderbuffer[H]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,B.__webglColorRenderbuffer[H]);const de=r.convert(se.format,se.colorSpace),ie=r.convert(se.type),he=S(se.internalFormat,de,ie,se.colorSpace,C.isXRRenderTarget===!0),Pe=vt(C);s.renderbufferStorageMultisample(s.RENDERBUFFER,Pe,he,C.width,C.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+H,s.RENDERBUFFER,B.__webglColorRenderbuffer[H])}s.bindRenderbuffer(s.RENDERBUFFER,null),C.depthBuffer&&(B.__webglDepthRenderbuffer=s.createRenderbuffer(),Fe(B.__webglDepthRenderbuffer,C,!0)),t.bindFramebuffer(s.FRAMEBUFFER,null)}}if(U){t.bindTexture(s.TEXTURE_CUBE_MAP,$.__webglTexture),qe(s.TEXTURE_CUBE_MAP,b);for(let H=0;H<6;H++)if(b.mipmaps&&b.mipmaps.length>0)for(let se=0;se<b.mipmaps.length;se++)Me(B.__webglFramebuffer[H][se],C,b,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+H,se);else Me(B.__webglFramebuffer[H],C,b,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+H,0);m(b)&&p(s.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(W){for(let H=0,se=I.length;H<se;H++){const de=I[H],ie=n.get(de);let he=s.TEXTURE_2D;(C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(he=C.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(he,ie.__webglTexture),qe(he,de),Me(B.__webglFramebuffer,C,de,s.COLOR_ATTACHMENT0+H,he,0),m(de)&&p(he)}t.unbindTexture()}else{let H=s.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(H=C.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(H,$.__webglTexture),qe(H,b),b.mipmaps&&b.mipmaps.length>0)for(let se=0;se<b.mipmaps.length;se++)Me(B.__webglFramebuffer[se],C,b,s.COLOR_ATTACHMENT0,H,se);else Me(B.__webglFramebuffer,C,b,s.COLOR_ATTACHMENT0,H,0);m(b)&&p(H),t.unbindTexture()}C.depthBuffer&&je(C)}function gt(C){const b=C.textures;for(let B=0,$=b.length;B<$;B++){const I=b[B];if(m(I)){const U=M(C),W=n.get(I).__webglTexture;t.bindTexture(U,W),p(U),t.unbindTexture()}}}const He=[],Oe=[];function we(C){if(C.samples>0){if(Ee(C)===!1){const b=C.textures,B=C.width,$=C.height;let I=s.COLOR_BUFFER_BIT;const U=C.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,W=n.get(C),H=b.length>1;if(H)for(let de=0;de<b.length;de++)t.bindFramebuffer(s.FRAMEBUFFER,W.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+de,s.RENDERBUFFER,null),t.bindFramebuffer(s.FRAMEBUFFER,W.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+de,s.TEXTURE_2D,null,0);t.bindFramebuffer(s.READ_FRAMEBUFFER,W.__webglMultisampledFramebuffer);const se=C.texture.mipmaps;se&&se.length>0?t.bindFramebuffer(s.DRAW_FRAMEBUFFER,W.__webglFramebuffer[0]):t.bindFramebuffer(s.DRAW_FRAMEBUFFER,W.__webglFramebuffer);for(let de=0;de<b.length;de++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(I|=s.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(I|=s.STENCIL_BUFFER_BIT)),H){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,W.__webglColorRenderbuffer[de]);const ie=n.get(b[de]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,ie,0)}s.blitFramebuffer(0,0,B,$,0,0,B,$,I,s.NEAREST),l===!0&&(He.length=0,Oe.length=0,He.push(s.COLOR_ATTACHMENT0+de),C.depthBuffer&&C.resolveDepthBuffer===!1&&(He.push(U),Oe.push(U),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,Oe)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,He))}if(t.bindFramebuffer(s.READ_FRAMEBUFFER,null),t.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),H)for(let de=0;de<b.length;de++){t.bindFramebuffer(s.FRAMEBUFFER,W.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+de,s.RENDERBUFFER,W.__webglColorRenderbuffer[de]);const ie=n.get(b[de]).__webglTexture;t.bindFramebuffer(s.FRAMEBUFFER,W.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+de,s.TEXTURE_2D,ie,0)}t.bindFramebuffer(s.DRAW_FRAMEBUFFER,W.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&l){const b=C.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[b])}}}function vt(C){return Math.min(i.maxSamples,C.samples)}function Ee(C){const b=n.get(C);return C.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function We(C){const b=o.render.frame;h.get(C)!==b&&(h.set(C,b),C.update())}function Nt(C,b){const B=C.colorSpace,$=C.format,I=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||B!==jt&&B!==mi&&(Je.getTransfer(B)===at?($!==yn||I!==Ln)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",B)),b}function Et(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(c.width=C.naturalWidth||C.width,c.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(c.width=C.displayWidth,c.height=C.displayHeight):(c.width=C.width,c.height=C.height),c}this.allocateTextureUnit=z,this.resetTextureUnits=F,this.setTexture2D=q,this.setTexture2DArray=j,this.setTexture3D=ne,this.setTextureCube=Y,this.rebindTextures=Ut,this.setupRenderTarget=D,this.updateRenderTargetMipmap=gt,this.updateMultisampleRenderTarget=we,this.setupDepthRenderbuffer=je,this.setupFrameBufferTexture=Me,this.useMultisampledRTT=Ee}function Xv(s,e){function t(n,i=mi){let r;const o=Je.getTransfer(i);if(n===Ln)return s.UNSIGNED_BYTE;if(n===_l)return s.UNSIGNED_SHORT_4_4_4_4;if(n===xl)return s.UNSIGNED_SHORT_5_5_5_1;if(n===qh)return s.UNSIGNED_INT_5_9_9_9_REV;if(n===Yh)return s.UNSIGNED_INT_10F_11F_11F_REV;if(n===Wh)return s.BYTE;if(n===Xh)return s.SHORT;if(n===er)return s.UNSIGNED_SHORT;if(n===vl)return s.INT;if(n===Oi)return s.UNSIGNED_INT;if(n===Rn)return s.FLOAT;if(n===ei)return s.HALF_FLOAT;if(n===jh)return s.ALPHA;if(n===Kh)return s.RGB;if(n===yn)return s.RGBA;if(n===nr)return s.DEPTH_COMPONENT;if(n===ir)return s.DEPTH_STENCIL;if(n===yl)return s.RED;if(n===bl)return s.RED_INTEGER;if(n===$h)return s.RG;if(n===Ml)return s.RG_INTEGER;if(n===Sl)return s.RGBA_INTEGER;if(n===Qr||n===eo||n===to||n===no)if(o===at)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Qr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===eo)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===to)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===no)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Qr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===eo)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===to)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===no)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===La||n===Da||n===Ia||n===Ua)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===La)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Da)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Ia)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Ua)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Na||n===Fa||n===Oa)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Na||n===Fa)return o===at?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Oa)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===ka||n===Ba||n===za||n===Ha||n===Va||n===Ga||n===Wa||n===Xa||n===qa||n===Ya||n===ja||n===Ka||n===$a||n===Za)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===ka)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ba)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===za)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Ha)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Va)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Ga)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Wa)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Xa)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===qa)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Ya)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===ja)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Ka)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===$a)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Za)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ja||n===Qa||n===el)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Ja)return o===at?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Qa)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===el)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===tl||n===nl||n===il||n===sl)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===tl)return r.COMPRESSED_RED_RGTC1_EXT;if(n===nl)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===il)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===sl)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===tr?s.UNSIGNED_INT_24_8:s[n]!==void 0?s[n]:null}return{convert:t}}const qv=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}bs.BlurDirectionX=new oe(1,0);bs.BlurDirectionY=new oe(0,1);const jr={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
  ...
  `},ve={cold:.06,warm:.14,machine:.3,human:.62,ember:.8};function T_(s,e){if(!s.attributes.position)return;const t=s.attributes.position.count,n=s.getAttribute("aHeat");n&&n.count===t?(n.array.fill(e),n.needsUpdate=!0):s.setAttribute("aHeat",new Mt(new Float32Array(t).fill(e),1))}function Gl(s,e=ve.cold){s.traverse(t=>{const n=t;n.geometry&&(t.isSprite||T_(n.geometry,n.userData.heat??e))})}function w_(){return new Dt({uniforms:{uTime:{value:0}},vertexShader:`
...
`);this.workerSourceURL=URL.createObjectURL(new Blob([o]))}),this.decoderPending}_getWorker(e,t){return this._initDecoder().then(()=>{if(this.workerPool.length<this.workerLimit){const i=new Worker(this.workerSourceURL);i._callbacks={},i._taskCosts={},i._taskLoad=0,i.postMessage({type:"init",decoderConfig:this.decoderConfig}),i.onmessage=function(r){const o=r.data;switch(o.type){case"decode":i._callbacks[o.id].resolve(o);break;case"error":i._callbacks[o.id].reject(o);break;default:console.error('THREE.DRACOLoader: Unexpected message, "'+o.type+'"')}},this.workerPool.push(i)}else this.workerPool.sort(function(i,r){return i._taskLoad>r._taskLoad?-1:1});const n=this.workerPool[this.workerPool.length-1];return n._taskCosts[e]=t,n._taskLoad+=t,n})}_releaseTask(e,t){e._taskLoad-=e._taskCosts[t],delete e._callbacks[t],delete e._taskCosts[t]}debug(){console.log("Task load: ",this.workerPool.map(e=>e._taskLoad))}dispose(){for(let e=0;e<this.workerPool.length;++e)this.workerPool[e].terminate();return this.workerPool.length=0,this.workerSourceURL!==""&&URL.revokeObjectURL(this.workerSourceURL),this}}function Dx(){let s,e;onmessage=function(o){const a=o.data;switch(a.type){case"init":s=a.decoderConfig,e=new Promise(function(h){s.onModuleLoaded=function(u){h({draco:u})},DracoDecoderModule(s)});break;case"decode":const l=a.buffer,c=a.taskConfig;e.then(h=>{const u=h.draco,d=new u.Decoder;try{const f=t(u,d,new Int8Array(l),c),g=f.attributes.map(v=>v.array.buffer);f.index&&g.push(f.index.array.buffer),self.postMessage({type:"decode",id:a.id,geometry:f},g)}catch(f){console.error(f),self.postMessage({type:"error",id:a.id,error:f.message})}finally{u.destroy(d)}});break}};function t(o,a,l,c){const h=c.attributeIDs,u=c.attributeTypes;let d,f;const g=a.GetEncodedGeometryType(l);if(g===o.TRIANGULAR_MESH)d=new o.Mesh,f=a.DecodeArrayToMesh(l,l.byteLength,d);else if(g===o.POINT_CLOUD)d=new o.PointCloud,f=a.DecodeArrayToPointCloud(l,l.byteLength,d);else throw new Error("THREE.DRACOLoader: Unexpected geometry type.");if(!f.ok()||d.ptr===0)throw new Error("THREE.DRACOLoader: Decoding failed: "+f.error_msg());const v={index:null,attributes:[]};for(const m in h){const p=self[u[m]];let M,S;if(c.useUniqueIDs)S=h[m],M=a.GetAttributeByUniqueId(d,S);else{if(S=a.GetAttributeId(d,o[h[m]]),S===-1)continue;M=a.GetAttribute(d,S)}const y=i(o,a,d,m,p,M);m==="color"&&(y.vertexColorSpace=c.vertexColorSpace),v.attributes.push(y)}return g===o.TRIANGULAR_MESH&&(v.index=n(o,a,d)),o.destroy(d),v}function n(o,a,l){const h=l.num_faces()*3,u=h*4,d=o._malloc(u);a.GetTrianglesUInt32Array(l,u,d);const f=new Uint32Array(o.HEAPF32.buffer,d,h).slice();return o._free(d),{array:f,itemSize:1}}function i(o,a,l,c,h,u){const d=u.num_components(),g=l.num_points()*d,v=g*h.BYTES_PER_ELEMENT,m=r(o,h),p=o._malloc(v);a.GetAttributeDataArrayForAllPoints(l,u,m,v,p);const M=new h(o.HEAPF32.buffer,p,g).slice();return o._free(p),{name:c,array:M,itemSize:d}}function r(o,a){switch(a){case Float32Array:return o.DT_FLOAT32;case Int8Array:return o.DT_INT8;case Int16Array:return o.DT_INT16;case Int32Array:return o.DT_INT32;case Uint8Array:return o.DT_UINT8;case Uint16Array:return o.DT_UINT16;case Uint32Array:return o.DT_UINT32}}}const ma={};class Ix{loader;cache=new Map;pending=new Map;getLoader(){if(!this.loader){this.loader=new $_;const e=new Lx;e.setDecoderPath("https://www.gstatic.com/draco/versioned/decoders/1.5.7/"),this.loader.setDRACOLoader(e)}return this.loader}has(e){return ma[e]!==void 0}async preload(){const e=Object.keys(ma);await Promise.all(e.map(t=>this.load(t)))}async load(e){const t=ma[e];if(!t)return null;if(this.cache.has(e))return this.cache.get(e);if(this.pending.has(e))return this.pending.get(e);const n=this.getLoader().loadAsync(t.url).then(i=>{const r=i.scene;return this.normalise(r,t),r.traverse(o=>{o.isMesh&&(o.castShadow=!0,o.receiveShadow=!0)}),this.cache.set(e,r),r}).catch(i=>(console.warn(`[ModelRegistry] не удалось загрузить ${e} (${t.url}):`,i),null));return this.pending.set(e,n),n}instantiate(e){const t=this.cache.get(e);return t?t.clone(!0):null}normalise(e,t){t.yawOffset&&(e.rotation.y=t.yawOffset);const n=new fn().setFromObject(e),i=n.getSize(new E);if(t.targetHeight&&i.y>1e-4){const o=t.targetHeight/i.y;e.scale.multiplyScalar(o),n.setFromObject(e)}const r=n.getCenter(new E);e.position.x-=r.x,e.position.z-=r.z,e.position.y-=t.groundAlign===!1?r.y:n.min.y}dispose(){for(const e of this.cache.values())e.traverse(t=>{const n=t;n.geometry?.dispose();const i=n.material;Array.isArray(i)?i.forEach(r=>r.dispose()):i?.dispose()});this.cache.clear(),this.pending.clear()}}const Ms=new Ix,Zt=13,Fn=.7,ga=5,Kr=60;function Ux(s){const e=new ut;e.name="level01";const t=[],n=[],i=new Map,r=[];let o=0;const a=(I,U="solid",W,H=!0)=>{const se={box:I,kind:U,id:W??`col${o++}`,enabled:H};return t.push(se),se},l=(I,U="solid",W=!0)=>(e.add(I),I.updateWorldMatrix(!0,!1),a(new fn().setFromObject(I),U),W&&n.push(I),I),c=I=>(e.add(I),I),h=q_();e.add(h);const u=new ep(7770292,4864816,1.85);e.add(u);const d=new io(16766120,2.3);d.position.set(48,42,-56),d.castShadow=!0,d.shadow.mapSize.set(2048,2048),d.shadow.camera.near=1,d.shadow.camera.far=180,d.shadow.camera.left=-70,d.shadow.camera.right=70,d.shadow.camera.top=70,d.shadow.camera.bottom=-70,d.shadow.bias=-6e-4,d.shadow.normalBias=.035,e.add(d),e.add(d.target),d.target.position.set(0,0,0);const f=new io(10335452,.95);f.position.set(-34,30,62),e.add(f);const g=new io(16751186,.4);g.position.set(10,-18,-30),e.add(g);const v=new Fi(760,760,1,1);v.rotateX(-Math.PI/2),r.push(v);const m=new De(v,s.asphalt);m.receiveShadow=!0,m.userData.heat=ve.cold,m.name="ground",e.add(m);const p=ce(84,.14,54,s.concrete,0,.07,-14,{tile:6,cast:!1});p.receiveShadow=!0,e.add(p);const M=K_(s);e.add(M.group);const S=ce(16,.1,210,s.asphalt,0,.05,92,{tile:9,cast:!1});S.receiveShadow=!0,e.add(S);for(let I=20;I<190;I+=9){const U=ce(.36,.02,4.4,s.paint,0,.13,I,{tile:2,cast:!1});U.receiveShadow=!1,c(U)}for(const I of[-7.2,7.2])c(ce(.28,.02,200,s.paint,I,.13,96,{tile:40,cast:!1}));for(let I=0;I<4;I++)c(ce(.22,.02,9,s.paint,-13+I*4.6,.16,44,{tile:6,cast:!1}));const y={tile:3.2,heat:ve.warm};l(ce(27,Zt,Fn,s.siding,-18.5,Zt/2,6,y)),l(ce(27,Zt,Fn,s.siding,18.5,Zt/2,6,y)),l(ce(ga*2+.8,5,Fn,s.siding,0,10.5,6,y)),l(ce(Fn,Zt,42,s.siding,-32,Zt/2,-15,y)),l(ce(Fn,Zt,42,s.siding,32,Zt/2,-15,y)),l(ce(64,Zt,Fn,s.siding,0,Zt/2,-36,y)),l(ce(24,Zt,Fn,s.concreteWall,-20,Zt/2,-16,{tile:3,heat:ve.warm})),l(ce(22,Zt,Fn,s.concreteWall,21,Zt/2,-16,{tile:3,heat:ve.warm})),c(ce(3.2,4.5,Fn+.05,s.charred,-6.4,10.6,-16,{tile:2,rotZ:.14,heat:ve.ember})),c(ce(2.4,3.2,Fn+.05,s.charred,9.2,11.2,-16,{tile:2,rotZ:-.2,heat:ve.ember})),l(ce(64,.7,20,s.roof,0,Zt+.35,-26,{tile:4,heat:ve.warm}));const R=[[-22,11.4,-14.4,-.42,.1],[-4,12.1,-14.8,.34,-.16],[16,11,-14.2,-.55,.22],[27,12.4,-15,.28,.08]];for(const[I,U,W,H,se]of R)c(ce(7.5,.45,5.5,s.charred,I,U,W,{tile:3,rotX:H,rotZ:se,heat:ve.ember}));for(const I of[-1,1])l(ce(.7,8,1,s.hazard,I*(ga+.35),4,6,{tile:2,heat:ve.warm}),"solid",!1);c(ce(ga*2+1.4,.55,1.1,s.hazard,0,8.05,6,{tile:2,heat:ve.warm}));const T=new ut,A=Ms.instantiate("building.annex");if(A)A.position.set(-15,0,-8),T.add(A);else{T.add(ce(10,5,10,s.sidingDark,-15,2.5,-8,{tile:2.6,heat:ve.warm})),T.add(ce(10.6,.35,10.6,s.concreteWall,-15,5.15,-8,{tile:2.6,heat:ve.warm}));for(const[I,U,W,H]of[[0,-5.1,10.6,.35],[0,5.1,10.6,.35],[-5.1,0,.35,10.6],[5.1,0,.35,10.6]])T.add(ce(W,.45,H,s.concreteWall,-15+I,5.55,-8+U,{tile:2,heat:ve.warm}));T.add(ce(1.6,1,1.6,s.rust,-18.2,5.8,-11,{tile:1.2,heat:ve.machine})),T.add(ct(.45,.45,1.4,s.rust,-11.8,6,-4.9,12,{heat:ve.machine}));for(let I=0;I<9;I++)T.add(ct(.05,.05,.7,s.rust,-10.15,.6+I*.55,-8,6,{rotZ:Math.PI/2}));T.add(ce(.12,5.4,.12,s.rust,-10.15,2.9,-8.38,{tile:1})),T.add(ce(.12,5.4,.12,s.rust,-10.15,2.9,-7.62,{tile:1}))}e.add(T),T.updateWorldMatrix(!0,!0),a(dn(-15,2.75,-8,10.7,5.5,10.7)),n.push(T);const P=[[14,0,-6,.14],[19.5,0,-13.5,-.32],[14.2,2.62,-6.2,.09],[-3,0,-25.5,1.42]];for(const[I,U,W,H]of P){const se=ce(6.2,2.55,2.6,s.container,I,U+1.28,W,{tile:2.2,rotY:H,heat:ve.warm});l(se);for(let de=-2;de<=2;de++){const ie=ce(.12,2.4,2.66,s.rust,0,0,0,{tile:1.2,heat:ve.warm});ie.position.set(de*1.2,0,0),se.add(ie)}}for(const[I,U,W,H]of[[6,-3,.3,3],[-2,-9,-.5,2],[24,-3,.9,4],[-22,-20,.2,3]]){for(let se=0;se<H;se++)c(ce(1.2,.16,1,s.wood,I+se*.04,.22+se*.19,U,{tile:.8,rotY:W}));c(ce(1,.9,.85,s.cardboard,I,.22+H*.19+.45,U,{tile:.9,rotY:W}))}for(const[I,U]of[[8.5,-18],[9.6,-19.2],[-24,-6]]){const W=ct(.42,.42,1.1,s.rust,I,.55,U,14,{heat:ve.warm});l(W,"solid",!1)}for(const[I,U,W]of[[-8,-15.5,3.2],[11,-15,2.6],[24,-16.5,2.2],[-19,-15.2,2]]){const H=new as(W,W*.55,9,1);r.push(H);const se=new De(H,s.charred);se.position.set(I,W*.26,U),se.rotation.y=Math.random()*Math.PI,se.castShadow=!0,se.receiveShadow=!0,se.userData.heat=ve.ember,e.add(se),a(dn(I,W*.28,U,W*1.7,W*.6,W*1.7))}const _=52,x=-50,L=62,F=3.1,z=9,X=new ut,q=(I,U,W,H)=>{const se=W-I,de=H-U,ie=Math.hypot(se,de);if(ie<.5)return;const he=(I+W)/2,Pe=(U+H)/2,ye=Math.atan2(se,de);X.add(ce(.35,.6,ie,s.concreteWall,he,.3,Pe,{tile:2,rotY:ye}));const fe=Math.abs(se)>Math.abs(de);a(dn(he,F/2,Pe,fe?ie:.5,F,fe?.5:ie));const Ne=ce(.06,F-.6,ie,s.chainlink,he,.6+(F-.6)/2,Pe,{tile:.6,rotY:ye,cast:!1});X.add(Ne),X.add(ce(.1,.1,ie,s.rust,he,F,Pe,{tile:1,rotY:ye}));const N=Math.max(2,Math.round(ie/4));for(let re=0;re<=N;re++){const ue=re/N;X.add(ct(.09,.09,F+.25,s.rust,I+se*ue,(F+.25)/2,U+de*ue,8,{}))}};q(-_,x,-_,L),q(_,x,_,L),q(-_,x,_,x),q(-_,L,-z,L),q(z,L,_,L);for(const I of[-1,1])X.add(ce(.12,F,6.4,s.chainlink,I*(z+2.6),F/2,L-2.8,{tile:.6,rotY:I*.42,cast:!1})),X.add(ct(.12,.12,F+.4,s.rust,I*z,(F+.4)/2,L,8));e.add(X);const j=[],ne=F_(),Y=new Fi(1,1);Y.rotateX(-Math.PI/2),r.push(Y);const pe=new Wt({map:ne,transparent:!0,depthWrite:!1,blending:si,opacity:.5,fog:!0}),xe=new Wt({color:16767400,transparent:!0,opacity:1,depthWrite:!1,blending:si,side:Gt,fog:!0,vertexColors:!0}),Le=(I,U)=>{const W=new as(I,U,14,6,!0),H=W.attributes.position,se=new Float32Array(H.count*4);for(let de=0;de<H.count;de++){const ie=H.getY(de)/U+.5,he=.008+Math.pow(ie,2.2)*.075;se[de*4]=1,se[de*4+1]=1,se[de*4+2]=1,se[de*4+3]=he}return W.setAttribute("color",new Mt(se,4)),W};for(const[I,U]of[[-38,-30],[38,-30],[-38,22],[38,22],[-26,52],[26,52]]){const H=ct(.22,.34,15,s.rust,I,7.5,U,10,{heat:ve.cold});e.add(H),a(dn(I,15/2,U,.8,15,.8));const se=Math.atan2(-I,-U),de=new ut;de.position.set(I,15-.4,U),de.rotation.y=se,de.add(ce(3.2,.18,.18,s.rust,0,0,0,{tile:1}));for(const N of[-1.1,1.1]){de.add(ce(.9,.55,.5,s.droneDark,N,-.35,0,{tile:.6}));const re=ce(.78,.42,.06,s.lampGlass.clone(),N,-.35,.28,{tile:.4,cast:!1});re.userData.heat=ve.machine,de.add(re),j.push(re)}e.add(de);const ie=Math.hypot(I,U),he=I-I/ie*9,Pe=U-U/ie*9,ye=new De(Y,pe);ye.position.set(he,.06,Pe),ye.scale.set(34,1,34),ye.renderOrder=2,ye.userData.heat=ve.cold,e.add(ye);const fe=Le(6,15);r.push(fe);const Ne=new De(fe,xe);Ne.position.set((I+he)/2,15/2,(U+Pe)/2),Ne.rotation.z=Math.atan2(I-he,15)*.6,Ne.rotation.x=-Math.atan2(U-Pe,15)*.6,Ne.renderOrder=3,Ne.userData.heat=ve.cold,e.add(Ne)}const qe=new as(.26,.72,10,1);r.push(qe);for(const[I,U]of[[-4.5,38],[4.5,38],[-6.5,46],[6.5,46],[-5.5,50],[5.5,50],[-9,12],[9,12],[-11,16],[11,16]]){const W=new De(qe,s.droneAccent);W.position.set(I,.36,U),W.castShadow=!0,W.userData.heat=ve.cold,e.add(W),c(ce(.62,.05,.62,s.droneDark,I,.03,U,{tile:.4,cast:!1}))}{const I=new gu([new E(1.6,.09,41),new E(4.2,.09,34),new E(1,.09,27),new E(3.4,.09,20),new E(.8,.09,13)]),U=new fo(I,60,.09,6,!1);r.push(U);const W=new De(U,s.droneAccent);W.castShadow=!0,W.receiveShadow=!0,W.userData.heat=ve.cold,e.add(W)}for(const[I,U,W]of[[-9.5,30,1.1],[-12.5,33,.85],[21,30,1]]){const H=new ut;H.position.set(I,W,U),H.rotation.z=Math.PI/2,H.add(ct(W,W,.12,s.wood,0,.42,0,14)),H.add(ct(W,W,.12,s.wood,0,-.42,0,14)),H.add(ct(W*.45,W*.45,.8,s.cable,0,0,0,12)),e.add(H),a(dn(I,W,U,W*2,W*2,1.1))}for(const[I,U,W]of[[-27,14,.2],[-27,18.4,-.1],[28,15,1.6]]){const H=ce(2.2,1.35,1.3,s.container,I,.68,U,{tile:1.2,rotY:W,heat:ve.cold});l(H,"solid",!1),c(ce(2.24,.1,1.34,s.droneDark,I,1.4,U,{tile:1,rotY:W}))}const st=new ur(1,14);st.rotateX(-Math.PI/2),r.push(st);const yt=new pt({color:1053979,roughness:.06,metalness:.5,transparent:!0,opacity:.78});for(const[I,U,W]of[[2.5,24,2.6],[-6,31,1.8],[8,33,2.1],[-3,17,1.5],[12.5,21,1.7],[-14,27,2.3],[5,44,1.4]]){const H=new De(st,yt);H.position.set(I,.035,U),H.scale.set(W,1,W*.72),H.rotation.y=I*1.7,H.userData.heat=ve.cold,e.add(H)}const Qe=12.3,Z=new ut;for(const I of[-1,1]){const U=ct(.19,.26,13.2,s.rust,I*17,6.6,24,10,{heat:ve.warm});Z.add(U),Z.add(ce(2.6,.16,.16,s.rust,I*17,Qe,24,{tile:1})),a(dn(I*17,6.6,24,.6,13.2,.6))}for(const[I,U]of[[-.9,11],[0,10.8],[.9,11]]){const W=new Nl(new E(-17,Qe,24+I),new E(0,U*2-Qe,24+I),new E(17,Qe,24+I)),H=new fo(W,24,.05,5,!1);r.push(H);const se=new De(H,s.cable);se.castShadow=!0,se.userData.heat=ve.cold,Z.add(se)}e.add(Z),a(dn(0,11.55,24,34,1.75,1.9),"wire","powerline");const K=new ut;K.position.set(0,0,42);const Me=Ms.instantiate("vehicle.rescueVan"),Fe=[];if(Me)K.add(Me);else{K.add(ce(3,1.45,2.5,s.vanBody,0,1.62,-3,{tile:1.6,heat:ve.machine})),K.add(ce(2.86,.85,.18,s.glass,0,2.05,-4.22,{tile:1})),K.add(ce(.18,.8,2,s.glass,-1.52,2,-3,{tile:1})),K.add(ce(.18,.8,2,s.glass,1.52,2,-3,{tile:1})),K.add(ce(3.1,2.5,5.4,s.vanBody,0,2.05,.9,{tile:1.8,heat:ve.machine})),K.add(ce(3.16,.62,5.44,s.hazard,0,1.25,.9,{tile:1.4})),K.add(ce(3.14,.16,5.44,s.vanTrim,0,3.24,.9,{tile:1.6})),K.add(ce(2.7,.35,8.2,s.droneDark,0,.72,-.6,{tile:1.6}));for(const[I,U]of[[-1.5,-2.7],[1.5,-2.7],[-1.5,1.9],[1.5,1.9]])K.add(ct(.52,.52,.34,s.tyre,I,.52,U,16,{rotZ:Math.PI/2})),K.add(ct(.24,.24,.36,s.vanTrim,I,.52,U,12,{rotZ:Math.PI/2}));K.add(ce(.12,2.3,1.9,s.vanBody,-2.05,2.05,3.3,{tile:1.4,rotY:-1.45})),K.add(ce(.12,2.3,1.9,s.vanBody,2.05,2.05,3.3,{tile:1.4,rotY:1.45})),K.add(ce(2.4,.14,3,s.droneDark,0,.92,5,{tile:1.2,heat:ve.machine})),K.add(ce(2.44,.1,.24,s.hazard,0,1.02,6.42,{tile:1}));for(const I of[-1,1])K.add(ct(.06,.06,.85,s.droneDark,I,.44,6.1,8));K.add(ce(2.2,.12,.3,s.droneDark,0,3.42,-3.1,{tile:1}));for(const[I,U]of[[-.72,16724770],[.72,3377407]]){const W=new tn(.52,.2,.26);r.push(W);const H=new De(W,new pt({color:U,emissive:U,emissiveIntensity:2.4,roughness:.4}));H.position.set(I,3.56,-3.1),H.userData.heat=ve.machine,Fe.push(H),K.add(H)}}const Ce=new Fi(3,3.6);Ce.rotateX(-Math.PI/2),r.push(Ce);const je=new De(Ce,s.helipad);je.position.set(0,3.34,.6),je.receiveShadow=!0,je.userData.heat=ve.machine,K.add(je),e.add(K),K.updateWorldMatrix(!0,!0),n.push(K),a(dn(0,1.9,42+.4,3.2,3.1,8.6)),a(dn(0,.9,47,2.5,.3,3.1));const Ut=new E(0,3.34,42.6),D={position:new E(0,1.35,47.2),yaw:Math.PI};for(const[I,U]of[[-3.4,46.4],[3.4,46.4],[-4.6,43],[4.6,43]]){const W=new as(.28,.72,10);r.push(W);const H=new De(W,new pt({color:16738848,roughness:.75}));H.position.set(I,.36,U),H.castShadow=!0,H.userData.heat=ve.cold,e.add(H),c(ce(.6,.05,.6,s.droneDark,I,.03,U,{tile:.5,cast:!1}))}for(const I of[-1,1]){const U=new ut;U.add(ct(.14,.18,8.5,s.rust,0,4.25,0,10,{heat:ve.warm})),U.add(ce(.16,.16,2.2,s.rust,0,8.4,I*-1,{tile:1,rotX:.12}));const W=new tn(.7,.18,1.1);r.push(W);const H=new De(W,new pt({color:2764598,emissive:16768168,emissiveIntensity:1.5,roughness:.5}));H.position.set(0,8.28,I*-2),H.userData.heat=ve.machine,U.add(H),U.position.set(I*12,0,44),e.add(U),a(dn(I*12,4.25,44,.5,8.5,.5));const se=new kl(16766112,22,26,2);se.position.set(I*12,8.1,44+I*-2),e.add(se)}const gt=ce(11.5,.85,.85,s.charred,0,7.55,5.1,{tile:2,heat:ve.ember,name:"gateBeam"});e.add(gt);const He=[ce(.3,.7,.9,s.rust,-4.4,7.9,5.5,{tile:1}),ce(.3,.7,.9,s.rust,4.4,7.9,5.5,{tile:1})];He.forEach(I=>e.add(I));const Oe=a(dn(0,4.1,6.4,11.2,8.2,2.6),"soft","gateFireWall",!1),we=a(dn(0,.9,6.9,12.4,1.8,1.6),"solid","gateBeam",!1);i.set("gateBeam",new Sh({id:"gateBeam",object:gt,endPosition:new E(0,-7.1,1.8),endRotation:new Mn(.06,.11,.19),duration:1.15,impactAt:.86,colliderAfter:we.box,onImpact:()=>{we.enabled=!0,Oe.enabled=!0,He.forEach(I=>I.visible=!1)}}));const vt=ce(6,6.5,.6,s.concreteWall,8.5,9.6,-15.7,{tile:3,heat:ve.ember,name:"fallingWall"});e.add(vt);const Ee=a(dn(8.5,1,-12.6,6.4,2,6.4),"solid","fallenWall",!1);i.set("courtyardWall",new Sh({id:"courtyardWall",object:vt,endPosition:new E(.4,-9,3.1),endRotation:new Mn(-Math.PI/2+.14,.06,.1),duration:1.35,impactAt:.88,colliderAfter:Ee.box,onImpact:()=>{Ee.enabled=!0}}));const We=new fn(new E(-Kr,0,-Kr+4),new E(Kr,46,Kr+14)),Nt=[{id:"gate-a",group:"gate",position:new E(-3.1,.5,6.4),scale:2,objective:!0,startActive:!1,light:!0},{id:"gate-b",group:"gate",position:new E(.1,.5,6.4),scale:2.4,objective:!0,startActive:!1,light:!0},{id:"gate-c",group:"gate",position:new E(3.3,.5,6.4),scale:2,objective:!0,startActive:!1,light:!1},{id:"amb-1",group:"ambient",position:new E(13.5,.5,-7.2),scale:1.5,objective:!1,startActive:!0,light:!0},{id:"amb-2",group:"ambient",position:new E(-7,.5,-12.5),scale:1.2,objective:!1,startActive:!0,light:!0},{id:"amb-3",group:"ambient",position:new E(24.5,.5,-20),scale:1.7,objective:!1,startActive:!0,light:!1},{id:"amb-4",group:"ambient",position:new E(-2,13.8,-22),scale:1.4,objective:!1,startActive:!0,light:!1},{id:"amb-5",group:"ambient",position:new E(-24,.5,-18),scale:1,objective:!1,startActive:!0,light:!1}],Et=[{id:"storekeeper",position:new E(-15,5.4,-8),mass:78,facing:.6}],C={takeoff:new E(0,5.4,47.2),gate:new E(0,4.4,8.5),courtyard:new E(-15,8.2,-8),helipad:Ut.clone().setY(Ut.y+1.4)};Gl(e);let b=0;return{root:e,colliders:t,cameraBlockers:n,spawn:D,helipad:{position:Ut,radius:1.9},fires:Nt,survivors:Et,markers:C,destructibles:i,bounds:We,animate:(I,U)=>{Y_(h,I),M.animate(I,U),b+=U;for(let W=0;W<Fe.length;W++){const H=Fe[W].material,se=Math.max(0,Math.sin(b*7+W*Math.PI));H.emissiveIntensity=.35+se*3.6}for(let W=0;W<j.length;W++){const H=j[W].material;H.opacity=.78+Math.sin(b*(11+W*.7)+W)*.09}},dispose:()=>{for(const I of r)I.dispose();M.dispose(),e.traverse(I=>{I.geometry?.dispose()}),e.clear()}}}class Nx{constructor(e,t){this.opts=t,this.min.copy(e.min),this.max.copy(e.max);const n=new E;e.getSize(n);const i=new E;e.getCenter(i);const r=new tn(n.x,n.y,n.z);r.translate(i.x,i.y,i.z),this.material=new Dt({transparent:!0,depthWrite:!1,side:Yt,blending:si,fog:!1,uniforms:{uDrone:{value:new E},uTime:{value:0},uFade:{value:t.fadeDistance},uAlert:{value:0},uColor:{value:new _e(3655935)},uAlertColor:{value:new _e(16738858)}},vertexShader:`
      ...
      `}),this.mesh=new De(r,this.material),this.mesh.name="boundary",this.mesh.layers.set(Hn.ATMOSPHERE),this.mesh.renderOrder=30,this.mesh.frustumCulled=!1,this.mesh.visible=!1}mesh;material;min=new E;max=new E;distance=1/0;proximity=0;distanceToWall(e){return Math.min(e.x-this.min.x,this.max.x-e.x,e.z-this.min.z,this.max.z-e.z)}update(e,t){if(this.distance=this.distanceToWall(t),this.proximity=1-Math.min(1,Math.max(0,this.distance)/this.opts.fadeDistance),this.mesh.visible=this.proximity>.001,!this.mesh.visible)return;const n=this.material.uniforms;n.uDrone.value.copy(t),n.uTime.value+=e,n.uAlert.value=Math.min(1,Math.max(0,(this.proximity-.45)/.55))}dispose(){this.mesh.geometry.dispose(),this.material.dispose()}}const Pi=.78,$r=.42;class Fx{constructor(e){this.mat=e,this.state={battery:te.battery.capacity,batteryMax:te.battery.capacity,foam:te.foam.tank,foamMax:te.foam.tank,hull:te.hull.max,payload:0};const t=Ms.instantiate("drone.swift1");t?(this.body.add(t),this.buildWinch()):(this.buildAirframe(),this.buildWinch()),this.root.add(this.body),Gl(this.root,ve.machine)}root=new ut;state;nozzleLocal=new E(0,-.06,.62);winchLocal=new E(0,-.16,-.04);body=new ut;rotors=[];blurDiscs=[];navLights=[];strobe;gimbal=new ut;searchlight;cable;basket=new ut;rotorSpin=0;rotorRpm=0;strobePhase=0;tiltPitch=0;tiltRoll=0;buildAirframe(){const e=this.mat,t=ce(.52,.16,.78,e.droneShell,0,0,0,{tile:.5,heat:ve.machine});this.body.add(t);const n=new ni(.3,20,12,0,Math.PI*2,0,Math.PI/2);n.scale(1,.62,1.35);const i=new De(n,e.droneShell);i.position.y=.07,i.castShadow=!0,i.userData.heat=ve.machine,this.body.add(i),this.body.add(ce(.2,.035,.72,e.droneAccent,0,.24,0,{tile:.4,heat:ve.machine})),this.body.add(ce(.46,.04,.14,e.droneAccent,0,.2,-.28,{tile:.4,heat:ve.machine})),this.body.add(ce(.34,.13,.44,e.droneDark,0,-.13,-.05,{tile:.4,heat:ve.machine}));const r=new Il(.11,.3,6,12);r.rotateX(Math.PI/2);const o=new De(r,e.droneAccent);o.position.set(0,-.05,.18),o.castShadow=!0,o.userData.heat=ve.machine,this.body.add(o),this.body.add(ct(.035,.05,.22,e.droneDark,0,-.06,.52,10,{rotX:Math.PI/2,heat:ve.machine}));const a=ct(.05,.05,.1,e.droneDark,0,-.12,.3,10,{heat:ve.machine});this.body.add(a);const l=new ni(.09,14,10),c=new De(l,e.droneDark);c.castShadow=!0,c.userData.heat=ve.machine;const h=new xi(.045,.045,.03,12);h.rotateX(Math.PI/2);const u=new De(h,new pt({color:662052,roughness:.08,metalness:.9,emissive:667712,emissiveIntensity:.6}));u.position.z=.075,this.gimbal.add(c,u),this.gimbal.position.set(0,-.2,.3),this.body.add(this.gimbal),this.searchlight=new xu(16773334,32,34,.55,.45,1.4),this.searchlight.position.set(0,-.16,.36),this.searchlight.target.position.set(0,-2.4,3.2),this.body.add(this.searchlight),this.body.add(this.searchlight.target);const d=[[1,1],[-1,1],[-1,-1],[1,-1]];for(const[v,m]of d){const p=v*Pi*.707,M=m*Pi*.707,S=ce(.07,.06,Pi,e.droneShell,p/2,0,M/2,{tile:.4,rotY:Math.atan2(p,M),heat:ve.machine});this.body.add(S),this.body.add(ct(.075,.09,.13,e.droneDark,p,.05,M,12,{heat:ve.machine})),this.body.add(ct(.055,.055,.05,e.droneAccent,p,.13,M,12,{heat:ve.machine}));const y=new ut;y.position.set(p,.17,M);for(const _ of[0,Math.PI]){const x=new tn($r,.012,.07);x.translate($r/2,0,0);const L=new De(x,e.droneDark);L.rotation.y=_,L.rotation.z=.16*(v*m>0?1:-1),L.castShadow=!0,L.userData.heat=ve.machine,y.add(L)}this.body.add(y),this.rotors.push(y);const R=new ur($r,24);R.rotateX(-Math.PI/2);const T=new De(R,e.rotorBlur.clone());T.position.set(p,.172,M),T.userData.heat=ve.machine,this.body.add(T),this.blurDiscs.push(T);const A=new Zs($r+.04,.012,6,20,Math.PI);A.rotateX(-Math.PI/2);const P=new De(A,e.droneShell);P.position.set(p,.2,M),P.rotation.y=Math.atan2(-p,-M),P.userData.heat=ve.machine,this.body.add(P)}for(const v of[-1,1])this.body.add(ce(.045,.045,.66,e.droneDark,v*.24,-.31,.02,{tile:.4,heat:ve.machine})),this.body.add(ce(.04,.2,.04,e.droneDark,v*.24,-.21,.24,{tile:.3,heat:ve.machine})),this.body.add(ce(.04,.2,.04,e.droneDark,v*.24,-.21,-.2,{tile:.3,heat:ve.machine}));const f=new ni(.035,8,6),g=(v,m,p)=>{const M=new De(f,new pt({color:v,emissive:v,emissiveIntensity:2.2,roughness:.3}));return M.position.set(m,.02,p),M.userData.heat=ve.machine,this.body.add(M),M};this.navLights.push(g(3407718,Pi*.707,Pi*.707)),this.navLights.push(g(16724804,-Pi*.707,Pi*.707)),this.strobe=g(16777215,0,-.42)}buildWinch(){const e=this.mat;this.body.add(ct(.07,.07,.16,e.droneDark,0,-.14,-.06,10,{rotZ:Math.PI/2,heat:ve.machine}));const t=new xi(.012,.012,1,6);t.translate(0,-.5,0),this.cable=new De(t,e.cable),this.cable.position.copy(this.winchLocal),this.cable.visible=!1,this.cable.userData.heat=ve.cold,this.body.add(this.cable);const n=new De(new Zs(.34,.025,6,18),e.droneAccent);n.rotation.x=Math.PI/2,n.userData.heat=ve.machine;const i=new xi(.33,.33,.03,18),r=new De(i,e.droneDark);r.position.y=-.32,r.userData.heat=ve.machine;const o=new De(new Zs(.34,.02,6,18),e.droneAccent);o.rotation.x=Math.PI/2,o.position.y=-.3,o.userData.heat=ve.machine,this.basket.add(n,o,r);for(let a=0;a<4;a++){const l=a/4*Math.PI*2,c=ct(.014,.014,.32,e.droneAccent,Math.cos(l)*.33,-.16,Math.sin(l)*.33,6,{heat:ve.machine});this.basket.add(c);const h=ct(.008,.008,.36,e.cable,Math.cos(l)*.17,.17,Math.sin(l)*.17,4,{rotZ:Math.cos(l)*.5,rotX:-Math.sin(l)*.5});this.basket.add(h)}this.basket.visible=!1,this.body.add(this.basket)}setCable(e){const t=e>.02;this.cable.visible=t,this.basket.visible=t,t&&(this.cable.scale.y=e,this.basket.position.set(this.winchLocal.x,this.winchLocal.y-e,this.winchLocal.z))}setSearchlight(e){this.searchlight&&(this.searchlight.intensity=e?32:0)}updateVisuals(e,t,n,i,r){const o=te.flight,a=t.clone().applyAxisAngle(new E(0,1,0),-n),l=Math.max(1,o.maxSpeed),c=Lt(a.z/l,-1,1)*o.maxTilt,h=-Lt(a.x/l,-1,1)*o.maxTilt;this.tiltPitch=ot(this.tiltPitch,r?c:0,o.tiltResponse,e),this.tiltRoll=ot(this.tiltRoll,r?h:0,o.tiltResponse,e),this.body.rotation.set(this.tiltPitch,0,this.tiltRoll),this.root.rotation.y=n,this.gimbal.rotation.x=-this.tiltPitch*.85;const u=r?En(26,46,dt(i)):En(0,6,dt(i));this.rotorRpm=ot(this.rotorRpm,u,4.5,e),this.rotorSpin+=this.rotorRpm*e;for(let g=0;g<this.rotors.length;g++){this.rotors[g].rotation.y=this.rotorSpin*(g%2===0?1:-1);const v=dt((this.rotorRpm-8)/22);this.blurDiscs[g].material.opacity=v*.14,this.rotors[g].visible=v<.98}this.strobePhase+=e;const d=this.strobePhase%1.5,f=d<.05||d>.15&&d<.2?2.6:.04;this.strobe.material.emissiveIntensity=f;for(const g of this.navLights)g.material.emissiveIntensity=r?2:.8}get totalMass(){return te.mass.empty+this.state.payload}resetState(){this.state.battery=this.state.batteryMax=te.battery.capacity,this.state.foam=this.state.foamMax=te.foam.tank,this.state.hull=te.hull.max,this.state.payload=0,this.tiltPitch=0,this.tiltRoll=0,this.rotorRpm=0,this.setCable(0)}dispose(){this.root.traverse(e=>{e.geometry?.dispose()})}}class Ox{position=new E;velocity=new E;yaw=0;landed=!0;grounded=!0;holdAltitude=0;throttle=0;supportY=0;anchorX=0;anchorZ=0;pilotIdle=!0;justTookOff=!1;justLanded=!1;boundaryBlocked=!1;wind=new E;updraft=new E;tmp=new E;closest=new E;normal=new E;impactCooldown=0;reset(e,t){this.position.copy(e),this.velocity.set(0,0,0),this.yaw=t,this.landed=!0,this.grounded=!0,this.holdAltitude=e.y,this.anchorX=e.x,this.anchorZ=e.z,this.supportY=e.y-te.flight.radius,this.throttle=0,this.justTookOff=!1,this.justLanded=!1,this.impactCooldown=0}setWind(e,t,n){this.wind.set(e,t,n)}setUpdraft(e,t,n){this.updraft.set(e,t,n)}speedFactor(e){return Lt(1-e*te.mass.speedPenaltyPerKg,.32,1)}responseFactor(e){return Lt(1-e*te.mass.responsePenaltyPerKg,.3,1)}climbFactor(e){return Lt(1-e*te.mass.climbPenaltyPerKg,.18,1)}update(e,t,n,i,r){const o=te.flight;this.justTookOff=!1,this.justLanded=!1,this.impactCooldown=Math.max(0,this.impactCooldown-e);const a=this.speedFactor(n),l=this.responseFactor(n),c=this.climbFactor(n),h=Math.min(1,Math.hypot(t.moveX,t.moveY)),u=te.mass.empty+n>te.mass.maxTakeoff;if(this.pilotIdle=h<.15&&t.climb<.05,this.landed)if((t.climb>.08||h>.15)&&!u)this.landed=!1,this.justTookOff=!0,this.holdAltitude=this.position.y,this.anchorX=this.position.x,this.anchorZ=this.position.z;else{this.velocity.multiplyScalar(Math.exp(-12*e)),this.throttle=ot(this.throttle,Math.max(0,t.climb)*.5,6,e),this.yaw=ul(this.yaw,t.cameraYaw,o.yawResponse*.5,e);return}const d=Math.sin(t.cameraYaw),f=Math.cos(t.cameraYaw),g=o.maxSpeed*a;let v,m;if(h>.02)v=(t.moveY*d-t.moveX*f)*g,m=(t.moveY*f+t.moveX*d)*g,this.anchorX=this.position.x,this.anchorZ=this.position.z;else{const y=o.positionHoldMaxSpeed;v=Lt((this.anchorX-this.position.x)*o.positionHold,-y,y),m=Lt((this.anchorZ-this.position.z)*o.positionHold,-y,y)}const p=(h>.02?o.accelResponse:o.brakeResponse)*l;this.velocity.x=ot(this.velocity.x,v,p,e),this.velocity.z=ot(this.velocity.z,m,p,e);let M;Math.abs(t.climb)>.05?(M=t.climb*o.maxClimbSpeed*c,u&&(M=Math.min(M,-.6)),this.holdAltitude=this.position.y):(M=Lt((this.holdAltitude-this.position.y)*o.holdStrength,-o.maxClimbSpeed,o.maxClimbSpeed),u&&(M=-1.2)),this.velocity.y=ot(this.velocity.y,M,o.climbResponse,e),this.tmp.copy(this.wind).add(this.updraft).multiplyScalar(e),this.velocity.add(this.tmp),this.yaw=ul(this.yaw,t.cameraYaw,o.yawResponse,e),this.position.addScaledVector(this.velocity,e),this.position.y>o.maxAltitude&&(this.position.y=o.maxAltitude,this.velocity.y=Math.min(this.velocity.y,0),this.holdAltitude=Math.min(this.holdAltitude,o.maxAltitude)),this.clampToBounds(r,e),this.resolveCollisions(i);const S=dt(.42+h*.3+Math.abs(this.velocity.y)/Math.max(1,o.maxClimbSpeed)*.35+n/Math.max(1,te.mass.maxTakeoff)*.5);this.throttle=ot(this.throttle,S,5,e)}clampToBounds(e,t){const n=te.flight.radius,i=te.boundary,r=e.min.x+n,o=e.max.x-n,a=e.min.z+n,l=e.max.z-n,c=Math.min(this.position.x-r,o-this.position.x,this.position.z-a,l-this.position.z);if(c<i.brakeDistance){const h=dt(1-Math.max(0,c)/i.brakeDistance),u=i.pushStrength*h*h,d=i.pushMaxSpeed,f=(g,v,m,p)=>{const M=g-v,S=m-g;if(M<i.brakeDistance&&p<0){const y=dt(1-Math.max(0,M)/i.brakeDistance);return ot(p,Lt(M*i.pushStrength,0,d),u+y*4,t)}if(S<i.brakeDistance&&p>0){const y=dt(1-Math.max(0,S)/i.brakeDistance);return ot(p,-Lt(S*i.pushStrength,0,d),u+y*4,t)}return p};this.velocity.x=f(this.position.x,r,o,this.velocity.x),this.velocity.z=f(this.position.z,a,l,this.velocity.z)}this.boundaryBlocked=c<i.brakeDistance*.55,this.position.x<r?(this.position.x=r,this.velocity.x=Math.max(0,this.velocity.x)):this.position.x>o&&(this.position.x=o,this.velocity.x=Math.min(0,this.velocity.x)),this.position.z<a?(this.position.z=a,this.velocity.z=Math.max(0,this.velocity.z)):this.position.z>l&&(this.position.z=l,this.velocity.z=Math.min(0,this.velocity.z)),this.anchorX=Lt(this.anchorX,r,o),this.anchorZ=Lt(this.anchorZ,a,l)}resolveCollisions(e){const t=te.flight.radius;let n=!1,i=-1/0;for(let o=0;o<2;o++){for(const a of e){if(!a.enabled)continue;const l=a.box;this.closest.set(Lt(this.position.x,l.min.x,l.max.x),Lt(this.position.y,l.min.y,l.max.y),Lt(this.position.z,l.min.z,l.max.z)),this.normal.copy(this.position).sub(this.closest);const c=this.normal.lengthSq();if(c>=t*t)continue;const h=Math.sqrt(c);if(h<1e-5){this.pushOutOfBox(l,t),n=!0;continue}this.normal.divideScalar(h),this.position.addScaledVector(this.normal,t-h);const u=this.velocity.dot(this.normal);if(u<0){const d=-u,f=a.kind==="wire"?.1:te.flight.bounce;this.velocity.addScaledVector(this.normal,-u*(1+f)),o===0&&this.reportImpact(d,a.kind)}this.normal.y>.6&&(n=!0,i=Math.max(i,l.max.y))}if(this.position.y<t){const a=-this.velocity.y;this.position.y=t,this.velocity.y<0&&(this.velocity.y=0,o===0&&this.reportImpact(a,"ground")),n=!0,i=Math.max(i,0)}}this.grounded=n,n&&(this.supportY=i===-1/0?0:i);const r=this.velocity.length();!this.landed&&this.pilotIdle&&n&&r<1.1&&this.position.y-t<=this.supportY+.12&&(this.landed=!0,this.justLanded=!0,this.velocity.set(0,0,0),this.holdAltitude=this.position.y)}pushOutOfBox(e,t){const n=this.position.x-e.min.x,i=e.max.x-this.position.x,r=this.position.y-e.min.y,o=e.max.y-this.position.y,a=this.position.z-e.min.z,l=e.max.z-this.position.z,c=Math.min(n,i,r,o,a,l);c===o?this.position.y=e.max.y+t:c===r?this.position.y=e.min.y-t:c===i?this.position.x=e.max.x+t:c===n?this.position.x=e.min.x-t:c===l?this.position.z=e.max.z+t:this.position.z=e.min.z-t,this.velocity.multiplyScalar(.3)}reportImpact(e,t){if(this.impactCooldown>0||e<=te.hull.safeImpactSpeed)return;const n=t==="soft"?0:t==="wire"?1.15:1,i=(e-te.hull.safeImpactSpeed)*te.hull.impactDamagePerSpeed*n;this.impactCooldown=.35,xt.emit("drone:impact",{speed:e,damage:i,kind:t})}}class oo{points;capacity;count=0;positions;velocities;colorStart;colorEnd;ages;lives;sizeStart;sizeEnd;alphas;drags;gravities;rotations;rotSpeeds;attrPosition;attrColor;attrSize;attrAlpha;attrRot;material;tmpColor=new _e;constructor(e,t,n={}){this.capacity=t,this.positions=new Float32Array(t*3),this.velocities=new Float32Array(t*3),this.colorStart=new Float32Array(t*3),this.colorEnd=new Float32Array(t*3),this.ages=new Float32Array(t),this.lives=new Float32Array(t),this.sizeStart=new Float32Array(t),this.sizeEnd=new Float32Array(t),this.alphas=new Float32Array(t),this.drags=new Float32Array(t),this.gravities=new Float32Array(t),this.rotations=new Float32Array(t),this.rotSpeeds=new Float32Array(t);const i=new Ct;this.attrPosition=new Mt(new Float32Array(t*3),3),this.attrColor=new Mt(new Float32Array(t*3),3),this.attrSize=new Mt(new Float32Array(t),1),this.attrAlpha=new Mt(new Float32Array(t),1),this.attrRot=new Mt(new Float32Array(t),1),this.attrPosition.setUsage(Ps),this.attrColor.setUsage(Ps),this.attrSize.setUsage(Ps),this.attrAlpha.setUsage(Ps),this.attrRot.setUsage(Ps),i.setAttribute("position",this.attrPosition),i.setAttribute("aColor",this.attrColor),i.setAttribute("aSize",this.attrSize),i.setAttribute("aAlpha",this.attrAlpha),i.setAttribute("aRot",this.attrRot),i.setDrawRange(0,0),i.boundingSphere=new Dn(new E(0,8,-10),200);const r=n.fog??!1;this.material=new Dt({uniforms:vs.merge([r?me.fog:{},{uTexture:{value:e},uHalfHeight:{value:540}}]),vertexShader:`
      ...
      `,transparent:!0,depthWrite:!1,side:Gt});const t=new ur(1,48);t.rotateX(-Math.PI/2),this.zoneRing=new De(t,this.zoneMaterial),this.zoneRing.layers.set(Hn.ATMOSPHERE),this.zoneRing.renderOrder=5,this.zoneRing.visible=!1;const n=new xi(1,1,1,32,1,!0);this.zoneColumn=new De(n,new Dt({uniforms:{uTime:{value:0},uColor:{value:new _e(5111712)}},vertexShader:`
          varying float vH;
          void main() {
            vH = uv.y;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
